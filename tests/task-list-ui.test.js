...
const CLIENT_VERSION = "20260607-topic-quick-note-v592";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260607-topic-quick-note-v592" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260607-topic-quick-note-v592"><\/noscript>/);
...
assert.match(appJs, /openPluginTopicApp\(pluginId\)[\s\S]*?state\.pluginContextNavPluginId = def\.id;[\s\S]*?rememberWardrobePluginReturnRoute\(\)/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260607-topic-quick-note-v592/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260607-topic-quick-note-v592/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260607-topic-quick-note-v592/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260607-topic-quick-note-v592/);
...
assert.match(appJs, /function openPluginTopicApp\(pluginId\)[\s\S]*?recordPluginTopicUsage\(def\.id\)/);
...
assert.match(appJs, /const offset = Math\.max\(58, rectHeight\)/);
