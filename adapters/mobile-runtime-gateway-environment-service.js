...
function createMobileRuntimeGatewayEnvironment(options = {}) {
  ...
  const GATEWAY_POOL_ELASTIC_CONFIG = {
    ...
    HERMES_MOBILE_GATEWAY_OWNER_DEEPSEEK_MAX_WORKERS: env.HERMES_MOBILE_GATEWAY_OWNER_DEEPSEEK_MAX_WORKERS,
    HERMES_WEB_GATEWAY_OWNER_DEEPSEEK_MAX_WORKERS: env.HERMES_WEB_GATEWAY_OWNER_DEEPSEEK_MAX_WORKERS,
    HERMES_MOBILE_GATEWAY_OWNER_MAINTENANCE_MAX_WORKERS: env.HERMES_MOBILE_GATEWAY_OWNER_MAINTENANCE_MAX_WORKERS,
    HERMES_WEB_GATEWAY_OWNER_MAINTENANCE_MAX_WORKERS: env.HERMES_WEB_GATEWAY_OWNER_MAINTENANCE_MAX_WORKERS,
    ...
    HERMES_MOBILE_GATEWAY_WORKSPACE_DEEPSEEK_MAX_WORKERS: env.HERMES_MOBILE_GATEWAY_WORKSPACE_DEEPSEEK_MAX_WORKERS,
    HERMES_WEB_GATEWAY_WORKSPACE_DEEPSEEK_MAX_WORKERS: env.HERMES_WEB_GATEWAY_WORKSPACE_DEEPSEEK_MAX_WORKERS,
  ...
  const RUN_WEB_SEARCH_MAX_CALLS = nonNegativeInteger(env.HERMES_MOBILE_RUN_WEB_SEARCH_MAX_CALLS || env.HERMES_WEB_RUN_WEB_SEARCH_MAX_CALLS || "12", 12);
  const RUN_EXPLICIT_WEB_SEARCH_MAX_CALLS = nonNegativeInteger(env.HERMES_MOBILE_RUN_EXPLICIT_WEB_SEARCH_MAX_CALLS || env.HERMES_WEB_RUN_EXPLICIT_WEB_SEARCH_MAX_CALLS || "20", 20);
