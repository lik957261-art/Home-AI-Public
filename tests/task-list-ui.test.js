...
assert.ok(indexHtml.includes("20260510-2359"));
assert.ok(serviceWorkerJs.includes("20260510-group-visibility-bottom-nav"));
assert.match(serverJs, /groupChatAvailable/);
assert.match(serverJs, /groupChatThreadId/);
assert.match(stylesCss, /--mobile-bottom-nav-height: calc\(72px \+ env\(safe-area-inset-bottom\)\)/);
assert.match(stylesCss, /padding-bottom: var\(--mobile-bottom-nav-height\)/);
