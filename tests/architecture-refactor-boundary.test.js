...
function testServiceFirstArchitectureContract() {
  ...
  assert.match(doc, /mobile-runtime-basic-helper-service\.js` must stay at or below 95 lines/);
  ...
  assert.ok(runtimeLineCount <= 1420, `mobile-server-runtime.js line budget exceeded: ${runtimeLineCount} > 1420`);
  assert.ok(runtimeTopLevelFunctionCount <= 32, `mobile-server-runtime.js top-level function budget exceeded: ${runtimeTopLevelFunctionCount} > 32`);
  ...
  assert.ok(basicHelperLineCount <= 95, `mobile-runtime-basic-helper-service.js line budget exceeded: ${basicHelperLineCount} > 95`);
