...
const CLIENT_VERSION = "20260619-run-progress-compact-follow-v860";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260619-run-progress-compact-follow-v860" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260619-run-progress-compact-follow-v860"><\/noscript>/);
...
assert.match(gatewayRunInstructionServiceJs, /20260619-music-multi-output-volume-v1/);
...
assert.match(appJs, /function cancelScheduledSelectedViewLoad\(\) \{[\s\S]*?window\.clearTimeout\(timer\);[\s\S]*?state\.scheduledSelectedViewLoadTimer = 0;/);
assert.match(appJs, /function scheduleSelectedViewLoad\(options = \{\}\) \{[\s\S]*?cancelScheduledSelectedViewLoad\(\);[\s\S]*?state\.scheduledSelectedViewLoadTimer = window\.setTimeout\(run, 0\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(indexHtml, /app-voice-input-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(serviceWorkerJs, /\/app-voice-input-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(indexHtml, /app-voice-learning-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
assert.match(serviceWorkerJs, /\/app-voice-learning-ui\.js\?v=20260619-run-progress-compact-follow-v860/);
