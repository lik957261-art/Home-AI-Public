  ...
  const runner = createRunner((command, args) => {
    ...
    if (command.endsWith("ps") && String(args.join(" ")).includes("rss")) {
      return {
        ...
        status: 0,
        stdout: [
          " 900 61.0 4026032 28:25 /Users/example/.local/bin/codex app-server --api-key secret-value",
          " 901 0.1 988320 28:25 /Users/example/codex-mobile-web/scripts/codex-app-server-mux.js",
          " 902 3.0 1921504 02:52 /Users/example/codex-mobile-web/server.js --launch-token must-not-leak",
          " 903 0.0 85040 27:41 /Users/example/codex-mobile-web/scripts/codex-mobile-mcp-server.js --key-file /secret/path",
