...
assert.match(configureLowGateways, /grok_auth_path="\$\{HERMES_GROK_GATEWAY_AUTH_PATH:-\$shared_auth_path\}"/);
assert.match(configureLowGateways, /grok_auth_lock_path="\$\{HERMES_GROK_GATEWAY_AUTH_LOCK_PATH:-\$shared_auth_lock_path\}"/);
...
assert.match(configureLowGateways, /merge_grok_xai_oauth_to_shared_auth/);
assert.match(configureLowGateways, /credential_pool", \{\}\)\.get\("xai-oauth"\)/);
assert.match(configureLowGateways, /last_status"\) == "ok"/);
...
assert.match(gatewayToolSchemaSmoke, /http_request,codex_mobile,weather,mobile_web_search,mobile_web_extract,image_generate,chatgpt_image_edit,chatgpt_image_erase,docx_extract_text,audio_transcribe/);
...
assert.match(httpPlugin, /CODEX_MOBILE_SCHEMA/);
assert.match(httpPlugin, /DEFAULT_CODEX_OWNER_PROFILES/);
assert.match(httpPlugin, /HERMES_MOBILE_CODEX_OWNER_PROFILES/);
assert.match(httpPlugin, /codex_mobile_owner_only/);
assert.match(httpPlugin, /"name": "http_request"/);
assert.match(httpPlugin, /"name": "cronjob_mobile"/);
assert.match(httpPlugin, /"name": "codex_mobile"/);
assert.match(httpPlugin, /toolset="http"/);
assert.match(httpPlugin, /hermes-mobile:\/\/cron/);
assert.match(httpPlugin, /hermes-mobile:\/\/codex-mux/);
...
assert.match(httpPlugin, /\/bridge\/codex-mux/);
