...
runtime wiring, workspace catalog lazy delegation, and process HTTP lifecycle
wiring addressable through CodeGraph without loading the full runtime root.
...
- `mobile-server-runtime.js` must stay at or below 2,390 lines while it is being split further;
