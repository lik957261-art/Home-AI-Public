...
const HERMES_SW_VERSION = "20260517-learning-bootstrap";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-learning-bootstrap",
  "/app-task-artifact-helpers.js?v=20260517-learning-bootstrap",
  "/app-kanban-story-helpers.js?v=20260517-learning-bootstrap",
  "/app-learning-reading-ui.js?v=20260517-learning-bootstrap",
  "/app-learning-coins-ui.js?v=20260517-learning-bootstrap",
  "/app-learning-program-ui.js?v=20260517-learning-bootstrap",
  "/app-learning-growth-ui.js?v=20260517-learning-bootstrap",
  "/app-api-client.js?v=20260517-learning-bootstrap",
  "/app.js?v=20260517-learning-bootstrap",
  "/app-shell-ui.js?v=20260517-learning-bootstrap",
  "/app-task-groups-ui.js?v=20260517-learning-bootstrap",
  "/app-chat-composer-ui.js?v=20260517-learning-bootstrap",
  "/app-composer-context-ui.js?v=20260517-learning-bootstrap",
  "/app-run-progress-ui.js?v=20260517-learning-bootstrap",
  "/app-navigation-search-ui.js?v=20260517-learning-bootstrap",
  "/app-sidebar-task-ui.js?v=20260517-learning-bootstrap",
  "/app-message-actions-ui.js?v=20260517-learning-bootstrap",
  "/app-platform-ui.js?v=20260517-learning-bootstrap",
  "/app-pwa-settings-push-ui.js?v=20260517-learning-bootstrap",
  "/app-workspace-admin-ui.js?v=20260517-learning-bootstrap",
  "/app-access-key-manager-ui.js?v=20260517-learning-bootstrap",
  "/app-share-image-ui.js?v=20260517-learning-bootstrap",
  "/app-draft-thread-ui.js?v=20260517-learning-bootstrap",
  "/app-directory-automation-ui.js?v=20260517-learning-bootstrap",
  "/app-shared-directory-ui.js?v=20260517-learning-bootstrap",
  "/app-automation-ui.js?v=20260517-learning-bootstrap",
  "/app-learning-growth-controller.js?v=20260517-learning-bootstrap",
  "/app-automation-controller-ui.js?v=20260517-learning-bootstrap",
  "/app-thread-state-ui.js?v=20260517-learning-bootstrap",
  "/app-group-topic-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-core-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-story-core-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-todo-core-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-render-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-list-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-learning-panel-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-recorder-ui.js?v=20260517-learning-bootstrap",
  "/app-todo-detail-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-actions-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-composer-actions-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-card-actions-ui.js?v=20260517-learning-bootstrap",
  "/app-kanban-study-actions-ui.js?v=20260517-learning-bootstrap",
  "/app-thread-message-ui.js?v=20260517-learning-bootstrap",
  "/app-thread-list-ui.js?v=20260517-learning-bootstrap",
  "/app-thread-directory-ui.js?v=20260517-learning-bootstrap",
  "/app-thread-card-message-ui.js?v=20260517-learning-bootstrap",
  "/app-rich-text-directory-ui.js?v=20260517-learning-bootstrap",
  "/app-message-usage-ui.js?v=20260517-learning-bootstrap",
  "/app-events-composer-ui.js?v=20260517-learning-bootstrap",
  "/app-event-stream-ui.js?v=20260517-learning-bootstrap",
  "/app-upload-sidebar-ui.js?v=20260517-learning-bootstrap",
  "/app-composer-send-ui.js?v=20260517-learning-bootstrap",
  "/app-wire-start-ui.js?v=20260517-learning-bootstrap",
  "/app-start.js?v=20260517-learning-bootstrap",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-learning-bootstrap",
  "/file-viewer.html",
