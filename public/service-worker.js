...
const HERMES_SW_VERSION = "20260518-growth-task-model";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260518-growth-task-model",
  "/app-task-artifact-helpers.js?v=20260518-growth-task-model",
  "/app-kanban-story-helpers.js?v=20260518-growth-task-model",
  "/app-learning-reading-ui.js?v=20260518-growth-task-model",
  "/app-learning-coins-ui.js?v=20260518-growth-task-model",
  "/app-learning-program-ui.js?v=20260518-growth-task-model",
  "/app-learning-growth-ui.js?v=20260518-growth-task-model",
  "/app-learning-growth-task-ui.js?v=20260518-growth-task-model",
  "/app-api-client.js?v=20260518-growth-task-model",
  "/app.js?v=20260518-growth-task-model",
  "/app-shell-ui.js?v=20260518-growth-task-model",
  "/app-task-groups-ui.js?v=20260518-growth-task-model",
  "/app-chat-composer-ui.js?v=20260518-growth-task-model",
  "/app-composer-context-ui.js?v=20260518-growth-task-model",
  "/app-run-progress-ui.js?v=20260518-growth-task-model",
  "/app-navigation-search-ui.js?v=20260518-growth-task-model",
  "/app-sidebar-task-ui.js?v=20260518-growth-task-model",
  "/app-message-actions-ui.js?v=20260518-growth-task-model",
  "/app-platform-ui.js?v=20260518-growth-task-model",
  "/app-pwa-settings-push-ui.js?v=20260518-growth-task-model",
  "/app-workspace-admin-ui.js?v=20260518-growth-task-model",
  "/app-access-key-manager-ui.js?v=20260518-growth-task-model",
  "/app-share-image-ui.js?v=20260518-growth-task-model",
  "/app-draft-thread-ui.js?v=20260518-growth-task-model",
  "/app-directory-automation-ui.js?v=20260518-growth-task-model",
  "/app-shared-directory-ui.js?v=20260518-growth-task-model",
  "/app-automation-ui.js?v=20260518-growth-task-model",
  "/app-learning-growth-controller.js?v=20260518-growth-task-model",
  "/app-automation-controller-ui.js?v=20260518-growth-task-model",
  "/app-thread-state-ui.js?v=20260518-growth-task-model",
  "/app-group-topic-ui.js?v=20260518-growth-task-model",
  "/app-kanban-core-ui.js?v=20260518-growth-task-model",
  "/app-kanban-story-core-ui.js?v=20260518-growth-task-model",
  "/app-kanban-todo-core-ui.js?v=20260518-growth-task-model",
  "/app-kanban-render-ui.js?v=20260518-growth-task-model",
  "/app-kanban-list-ui.js?v=20260518-growth-task-model",
  "/app-kanban-learning-panel-ui.js?v=20260518-growth-task-model",
  "/app-kanban-recorder-ui.js?v=20260518-growth-task-model",
  "/app-todo-detail-ui.js?v=20260518-growth-task-model",
  "/app-kanban-actions-ui.js?v=20260518-growth-task-model",
  "/app-kanban-composer-actions-ui.js?v=20260518-growth-task-model",
  "/app-kanban-card-actions-ui.js?v=20260518-growth-task-model",
  "/app-kanban-study-actions-ui.js?v=20260518-growth-task-model",
  "/app-thread-message-ui.js?v=20260518-growth-task-model",
  "/app-thread-list-ui.js?v=20260518-growth-task-model",
  "/app-thread-directory-ui.js?v=20260518-growth-task-model",
  "/app-thread-card-message-ui.js?v=20260518-growth-task-model",
  "/app-rich-text-directory-ui.js?v=20260518-growth-task-model",
  "/app-message-usage-ui.js?v=20260518-growth-task-model",
  "/app-events-composer-ui.js?v=20260518-growth-task-model",
  "/app-event-stream-ui.js?v=20260518-growth-task-model",
  "/app-upload-sidebar-ui.js?v=20260518-growth-task-model",
  "/app-composer-send-ui.js?v=20260518-growth-task-model",
  "/app-wire-start-ui.js?v=20260518-growth-task-model",
  "/app-start.js?v=20260518-growth-task-model",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260518-growth-task-model",
  "/file-viewer.html",
