...
helpers and JSON store file IO, workspace catalog lazy delegation, and process
...
- `mobile-server-runtime.js` must stay at or below 2,420 lines while it is being split further;
