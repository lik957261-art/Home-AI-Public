...
function initialHermesViewMode() {
  ...
  return saved === "todos" || saved === "capabilities" ? "tasks" : saved;
}
...
const state = {
  ...
  actionInboxPluginAuditSchedule: "0 22 * * 0",
  actionInboxPluginAuditMode: "recent_changes",
  learningGrowth: null,
