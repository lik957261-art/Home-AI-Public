...
assert.match(startGatewayPool, /"\$runtime_hermes" -p "\$profile" gateway run/);
...
assert.match(startLowGatewaysShell, /"\$runtime_hermes" -p "\$profile" gateway run --replace --accept-hooks/);
