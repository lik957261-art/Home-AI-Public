...
const HERMES_SW_VERSION = "20260519-search-source-v1";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260519-search-source-v1",
  "/app-task-artifact-helpers.js?v=20260519-search-source-v1",
  "/app-kanban-story-helpers.js?v=20260519-search-source-v1",
  "/app-learning-reading-ui.js?v=20260519-search-source-v1",
  "/app-learning-coins-ui.js?v=20260519-search-source-v1",
  "/app-learning-program-ui.js?v=20260519-search-source-v1",
  "/app-learning-growth-ui.js?v=20260519-search-source-v1",
  "/app-learning-growth-task-ui.js?v=20260519-search-source-v1",
  "/app-api-client.js?v=20260519-search-source-v1",
  "/app.js?v=20260519-search-source-v1",
  "/app-shell-ui.js?v=20260519-search-source-v1",
  "/app-task-groups-ui.js?v=20260519-search-source-v1",
  "/app-chat-composer-ui.js?v=20260519-search-source-v1",
  "/app-composer-source-ui.js?v=20260519-search-source-v1",
  "/app-composer-context-ui.js?v=20260519-search-source-v1",
  "/app-run-progress-ui.js?v=20260519-search-source-v1",
  "/app-navigation-search-ui.js?v=20260519-search-source-v1",
  "/app-sidebar-task-ui.js?v=20260519-search-source-v1",
  "/app-message-actions-ui.js?v=20260519-search-source-v1",
  "/app-platform-ui.js?v=20260519-search-source-v1",
  "/app-pwa-settings-push-ui.js?v=20260519-search-source-v1",
  "/app-workspace-admin-ui.js?v=20260519-search-source-v1",
  "/app-access-key-manager-ui.js?v=20260519-search-source-v1",
  "/app-share-image-ui.js?v=20260519-search-source-v1",
  "/app-draft-thread-ui.js?v=20260519-search-source-v1",
  "/app-directory-automation-ui.js?v=20260519-search-source-v1",
  "/app-shared-directory-ui.js?v=20260519-search-source-v1",
  "/app-automation-ui.js?v=20260519-search-source-v1",
  "/app-learning-growth-controller.js?v=20260519-search-source-v1",
  "/app-automation-controller-ui.js?v=20260519-search-source-v1",
  "/app-thread-state-ui.js?v=20260519-search-source-v1",
  "/app-group-topic-ui.js?v=20260519-search-source-v1",
  "/app-kanban-core-ui.js?v=20260519-search-source-v1",
  "/app-kanban-story-core-ui.js?v=20260519-search-source-v1",
  "/app-kanban-todo-core-ui.js?v=20260519-search-source-v1",
  "/app-kanban-render-ui.js?v=20260519-search-source-v1",
  "/app-kanban-list-ui.js?v=20260519-search-source-v1",
  "/app-kanban-learning-panel-ui.js?v=20260519-search-source-v1",
  "/app-kanban-recorder-ui.js?v=20260519-search-source-v1",
  "/app-todo-detail-ui.js?v=20260519-search-source-v1",
  "/app-kanban-actions-ui.js?v=20260519-search-source-v1",
  "/app-kanban-composer-actions-ui.js?v=20260519-search-source-v1",
  "/app-kanban-card-actions-ui.js?v=20260519-search-source-v1",
  "/app-kanban-study-actions-ui.js?v=20260519-search-source-v1",
  "/app-thread-message-ui.js?v=20260519-search-source-v1",
  "/app-thread-list-ui.js?v=20260519-search-source-v1",
  "/app-thread-directory-ui.js?v=20260519-search-source-v1",
  "/app-thread-card-message-ui.js?v=20260519-search-source-v1",
  "/app-rich-text-directory-ui.js?v=20260519-search-source-v1",
  "/app-message-usage-ui.js?v=20260519-search-source-v1",
  "/app-events-composer-ui.js?v=20260519-search-source-v1",
  "/app-event-stream-ui.js?v=20260519-search-source-v1",
  "/app-upload-sidebar-ui.js?v=20260519-search-source-v1",
  "/app-composer-send-ui.js?v=20260519-search-source-v1",
  "/app-wire-start-ui.js?v=20260519-search-source-v1",
  "/app-start.js?v=20260519-search-source-v1",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260519-search-source-v1",
  "/file-viewer.html",
