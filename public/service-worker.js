...
const HERMES_SW_VERSION = "20260517-app-shell-split";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-app-shell-split",
  "/app-task-artifact-helpers.js?v=20260517-app-shell-split",
  "/app-kanban-story-helpers.js?v=20260517-app-shell-split",
  "/app-learning-reading-ui.js?v=20260517-app-shell-split",
  "/app-learning-coins-ui.js?v=20260517-app-shell-split",
  "/app-learning-program-ui.js?v=20260517-app-shell-split",
  "/app-learning-growth-ui.js?v=20260517-app-shell-split",
  "/app-api-client.js?v=20260517-app-shell-split",
  "/app.js?v=20260517-app-shell-split",
  "/app-shell-ui.js?v=20260517-app-shell-split",
  "/app-task-groups-ui.js?v=20260517-app-shell-split",
  "/app-chat-composer-ui.js?v=20260517-app-shell-split",
  "/app-navigation-search-ui.js?v=20260517-app-shell-split",
  "/app-sidebar-task-ui.js?v=20260517-app-shell-split",
  "/app-message-actions-ui.js?v=20260517-app-shell-split",
  "/app-platform-ui.js?v=20260517-app-shell-split",
  "/app-workspace-admin-ui.js?v=20260517-app-shell-split",
  "/app-directory-automation-ui.js?v=20260517-app-shell-split",
  "/app-learning-growth-controller.js?v=20260517-app-shell-split",
  "/app-kanban-core-ui.js?v=20260517-app-shell-split",
  "/app-kanban-render-ui.js?v=20260517-app-shell-split",
  "/app-kanban-actions-ui.js?v=20260517-app-shell-split",
  "/app-thread-message-ui.js?v=20260517-app-shell-split",
  "/app-events-composer-ui.js?v=20260517-app-shell-split",
  "/app-start.js?v=20260517-app-shell-split",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-app-shell-split",
  "/file-viewer.html",
