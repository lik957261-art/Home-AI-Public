...
const HERMES_SW_VERSION = "20260514-reading-recorder-one-button";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260514-reading-recorder-one-button",
  "/app.js?v=20260514-reading-recorder-one-button",
