...
assert.match(appJs, /<a class="artifact-card doc-\$\{escapeHtml\(artifactKind\(artifact\)\)\}" href="\$\{escapeHtml\(artifactHref\(artifact\)\)\}" target="_blank" rel="noopener" data-task-doc>/);
assert.match(appJs, /<a class="task-doc-icon doc-\$\{escapeHtml\(artifactKind\(latestArtifact\)\)\}" href="\$\{escapeHtml\(artifactHref\(latestArtifact\)\)\}" target="_blank" rel="noopener" data-task-doc/);
