...
const { eventStreamApiRoutes, mobileApiDispatcher } = createMobileApiComposition({
  ...
  grantOwnerElevationOnce, groupAiReplyRevokedText: GROUP_AI_REPLY_REVOKED_TEXT, groupAssistantReplyForUserMessage, groupMessageRevokedText: GROUP_MESSAGE_REVOKED_TEXT, groupMessageRevoker,
  includeStatusCatalog: STATUS_INCLUDE_CATALOG, interpretAutomationNaturalLanguage, invalidateCatalogCache, isDirectoryBrowserPathAllowedForThread, isOwnerAuth,
  ...
  kanbanReadingWorkflowService, kanbanSingleCardCasePayload, listWorkspaceAccessKeyStatuses, loadCatalog, localWorkspaceDefaults,
  ...
  revokeGroupMessagePayload, revokeOwnerElevation, revokeWorkspaceAccessKey, rmdir: (value) => fs.rmdirSync(value), rotateGlobalAccessKey,
