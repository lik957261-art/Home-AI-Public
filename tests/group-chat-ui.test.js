...
assert.match(appJs, /function currentUserCanUseGroupChatThread\(thread = state\.currentThread\)/);
...
assert.match(appJs, /groupChat && !currentUserCanUseGroupChatThread\(state\.currentThread\)/);
