...
const HERMES_SW_VERSION = "20260517-app-runtime-split";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-app-runtime-split",
  "/app-task-artifact-helpers.js?v=20260517-app-runtime-split",
  "/app-kanban-story-helpers.js?v=20260517-app-runtime-split",
  "/app-learning-reading-ui.js?v=20260517-app-runtime-split",
  "/app-learning-coins-ui.js?v=20260517-app-runtime-split",
  "/app-learning-program-ui.js?v=20260517-app-runtime-split",
  "/app-learning-growth-ui.js?v=20260517-app-runtime-split",
  "/app-api-client.js?v=20260517-app-runtime-split",
  "/app.js?v=20260517-app-runtime-split",
  "/app-shell-ui.js?v=20260517-app-runtime-split",
  "/app-task-groups-ui.js?v=20260517-app-runtime-split",
  "/app-chat-composer-ui.js?v=20260517-app-runtime-split",
  "/app-navigation-search-ui.js?v=20260517-app-runtime-split",
  "/app-sidebar-task-ui.js?v=20260517-app-runtime-split",
  "/app-message-actions-ui.js?v=20260517-app-runtime-split",
  "/app-platform-ui.js?v=20260517-app-runtime-split",
  "/app-pwa-settings-push-ui.js?v=20260517-app-runtime-split",
  "/app-workspace-admin-ui.js?v=20260517-app-runtime-split",
  "/app-access-key-manager-ui.js?v=20260517-app-runtime-split",
  "/app-share-image-ui.js?v=20260517-app-runtime-split",
  "/app-draft-thread-ui.js?v=20260517-app-runtime-split",
  "/app-directory-automation-ui.js?v=20260517-app-runtime-split",
  "/app-shared-directory-ui.js?v=20260517-app-runtime-split",
  "/app-automation-ui.js?v=20260517-app-runtime-split",
  "/app-learning-growth-controller.js?v=20260517-app-runtime-split",
  "/app-automation-controller-ui.js?v=20260517-app-runtime-split",
  "/app-thread-state-ui.js?v=20260517-app-runtime-split",
  "/app-group-topic-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-core-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-story-core-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-todo-core-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-render-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-list-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-learning-panel-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-recorder-ui.js?v=20260517-app-runtime-split",
  "/app-todo-detail-ui.js?v=20260517-app-runtime-split",
  "/app-kanban-actions-ui.js?v=20260517-app-runtime-split",
  "/app-thread-message-ui.js?v=20260517-app-runtime-split",
  "/app-thread-list-ui.js?v=20260517-app-runtime-split",
  "/app-thread-directory-ui.js?v=20260517-app-runtime-split",
  "/app-thread-card-message-ui.js?v=20260517-app-runtime-split",
  "/app-rich-text-directory-ui.js?v=20260517-app-runtime-split",
  "/app-message-usage-ui.js?v=20260517-app-runtime-split",
  "/app-events-composer-ui.js?v=20260517-app-runtime-split",
  "/app-event-stream-ui.js?v=20260517-app-runtime-split",
  "/app-upload-sidebar-ui.js?v=20260517-app-runtime-split",
  "/app-composer-send-ui.js?v=20260517-app-runtime-split",
  "/app-wire-start-ui.js?v=20260517-app-runtime-split",
  "/app-start.js?v=20260517-app-runtime-split",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-app-runtime-split",
  "/file-viewer.html",
