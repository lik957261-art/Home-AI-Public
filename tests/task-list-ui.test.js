...
const CLIENT_VERSION = "20260526-inbox-growth-v249";
const appJs = [
...
assert.match(appJs, /const inboxView = state\.viewMode === "inbox"/);
assert.match(appJs, /const showTopMenu = [^;]*inboxView[^;]*;/);
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260526-inbox-growth-v249/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260526-inbox-growth-v249/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260526-inbox-growth-v249/);
