...
assert.match(stylesCss, /\.codex-mode \.conversation,[\s\S]*?\.email-mode \.conversation,[\s\S]*?\.health-mode \.conversation\s*\{[\s\S]*padding: 0;/);
assert.match(stylesCss, /\.embedded-plugin-host-active \.conversation\s*\{[\s\S]*display: none;/);
assert.match(stylesCss, /\.embedded-plugin-host-active \.topbar\s*\{[\s\S]*display: flex !important;/);
assert.match(stylesCss, /\.wardrobe-plugin-host-active \.topbar\s*\{[\s\S]*display: flex !important;/);
...
assert.match(stylesCss, /\.task-list-mode \.plugin-app-grid\s*\{[\s\S]*grid-template-columns: repeat\(4, minmax\(0, 1fr\)\);/);
