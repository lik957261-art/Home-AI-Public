...
const HERMES_SW_VERSION = "20260517-learning-source-directory";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-learning-source-directory",
  "/app-task-artifact-helpers.js?v=20260517-learning-source-directory",
  "/app-kanban-story-helpers.js?v=20260517-learning-source-directory",
  "/app-learning-reading-ui.js?v=20260517-learning-source-directory",
  "/app-learning-coins-ui.js?v=20260517-learning-source-directory",
  "/app-learning-program-ui.js?v=20260517-learning-source-directory",
  "/app-learning-growth-ui.js?v=20260517-learning-source-directory",
  "/app-api-client.js?v=20260517-learning-source-directory",
  "/app.js?v=20260517-learning-source-directory",
  "/app-shell-ui.js?v=20260517-learning-source-directory",
  "/app-task-groups-ui.js?v=20260517-learning-source-directory",
  "/app-chat-composer-ui.js?v=20260517-learning-source-directory",
  "/app-composer-context-ui.js?v=20260517-learning-source-directory",
  "/app-run-progress-ui.js?v=20260517-learning-source-directory",
  "/app-navigation-search-ui.js?v=20260517-learning-source-directory",
  "/app-sidebar-task-ui.js?v=20260517-learning-source-directory",
  "/app-message-actions-ui.js?v=20260517-learning-source-directory",
  "/app-platform-ui.js?v=20260517-learning-source-directory",
  "/app-pwa-settings-push-ui.js?v=20260517-learning-source-directory",
  "/app-workspace-admin-ui.js?v=20260517-learning-source-directory",
  "/app-access-key-manager-ui.js?v=20260517-learning-source-directory",
  "/app-share-image-ui.js?v=20260517-learning-source-directory",
  "/app-draft-thread-ui.js?v=20260517-learning-source-directory",
  "/app-directory-automation-ui.js?v=20260517-learning-source-directory",
  "/app-shared-directory-ui.js?v=20260517-learning-source-directory",
  "/app-automation-ui.js?v=20260517-learning-source-directory",
  "/app-learning-growth-controller.js?v=20260517-learning-source-directory",
  "/app-automation-controller-ui.js?v=20260517-learning-source-directory",
  "/app-thread-state-ui.js?v=20260517-learning-source-directory",
  "/app-group-topic-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-core-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-story-core-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-todo-core-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-render-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-list-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-learning-panel-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-recorder-ui.js?v=20260517-learning-source-directory",
  "/app-todo-detail-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-actions-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-composer-actions-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-card-actions-ui.js?v=20260517-learning-source-directory",
  "/app-kanban-study-actions-ui.js?v=20260517-learning-source-directory",
  "/app-thread-message-ui.js?v=20260517-learning-source-directory",
  "/app-thread-list-ui.js?v=20260517-learning-source-directory",
  "/app-thread-directory-ui.js?v=20260517-learning-source-directory",
  "/app-thread-card-message-ui.js?v=20260517-learning-source-directory",
  "/app-rich-text-directory-ui.js?v=20260517-learning-source-directory",
  "/app-message-usage-ui.js?v=20260517-learning-source-directory",
  "/app-events-composer-ui.js?v=20260517-learning-source-directory",
  "/app-event-stream-ui.js?v=20260517-learning-source-directory",
  "/app-upload-sidebar-ui.js?v=20260517-learning-source-directory",
  "/app-composer-send-ui.js?v=20260517-learning-source-directory",
  "/app-wire-start-ui.js?v=20260517-learning-source-directory",
  "/app-start.js?v=20260517-learning-source-directory",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-learning-source-directory",
  "/file-viewer.html",
