...
const CLIENT_VERSION = "20260617-directory-delete-inline-progress-v797";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260617-directory-delete-inline-progress-v797" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260617-directory-delete-inline-progress-v797"><\/noscript>/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(indexHtml, /app-voice-input-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(serviceWorkerJs, /\/app-voice-input-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(indexHtml, /app-voice-learning-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
assert.match(serviceWorkerJs, /\/app-voice-learning-ui\.js\?v=20260617-directory-delete-inline-progress-v797/);
