...
function testServiceFirstArchitectureContract() {
  ...
  assert.match(doc, /1,800 lines/);
  assert.match(doc, /140/);
  ...
  assert.ok(runtimeLineCount <= 1800, `mobile-server-runtime.js line budget exceeded: ${runtimeLineCount} > 1800`);
  assert.ok(runtimeTopLevelFunctionCount <= 140, `mobile-server-runtime.js top-level function budget exceeded: ${runtimeTopLevelFunctionCount} > 140`);
