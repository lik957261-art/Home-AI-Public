...
lazy delegation, system status lazy delegation, workspace catalog lazy
...
- `mobile-server-runtime.js` must stay at or below 2,290 lines while it is being split further;
