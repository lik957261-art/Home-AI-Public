...
const HERMES_SW_VERSION = "20260517-app-ui-split";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-app-ui-split",
  "/app-task-artifact-helpers.js?v=20260517-app-ui-split",
  "/app-kanban-story-helpers.js?v=20260517-app-ui-split",
  "/app-learning-reading-ui.js?v=20260517-app-ui-split",
  "/app-learning-coins-ui.js?v=20260517-app-ui-split",
  "/app-learning-program-ui.js?v=20260517-app-ui-split",
  "/app-learning-growth-ui.js?v=20260517-app-ui-split",
  "/app-api-client.js?v=20260517-app-ui-split",
  "/app.js?v=20260517-app-ui-split",
  "/app-shell-ui.js?v=20260517-app-ui-split",
  "/app-task-groups-ui.js?v=20260517-app-ui-split",
  "/app-chat-composer-ui.js?v=20260517-app-ui-split",
  "/app-navigation-search-ui.js?v=20260517-app-ui-split",
  "/app-sidebar-task-ui.js?v=20260517-app-ui-split",
  "/app-message-actions-ui.js?v=20260517-app-ui-split",
  "/app-platform-ui.js?v=20260517-app-ui-split",
  "/app-workspace-admin-ui.js?v=20260517-app-ui-split",
  "/app-directory-automation-ui.js?v=20260517-app-ui-split",
  "/app-learning-growth-controller.js?v=20260517-app-ui-split",
  "/app-kanban-core-ui.js?v=20260517-app-ui-split",
  "/app-kanban-render-ui.js?v=20260517-app-ui-split",
  "/app-kanban-list-ui.js?v=20260517-app-ui-split",
  "/app-kanban-learning-panel-ui.js?v=20260517-app-ui-split",
  "/app-kanban-recorder-ui.js?v=20260517-app-ui-split",
  "/app-todo-detail-ui.js?v=20260517-app-ui-split",
  "/app-kanban-actions-ui.js?v=20260517-app-ui-split",
  "/app-thread-message-ui.js?v=20260517-app-ui-split",
  "/app-thread-list-ui.js?v=20260517-app-ui-split",
  "/app-thread-directory-ui.js?v=20260517-app-ui-split",
  "/app-thread-card-message-ui.js?v=20260517-app-ui-split",
  "/app-rich-text-directory-ui.js?v=20260517-app-ui-split",
  "/app-message-usage-ui.js?v=20260517-app-ui-split",
  "/app-events-composer-ui.js?v=20260517-app-ui-split",
  "/app-event-stream-ui.js?v=20260517-app-ui-split",
  "/app-upload-sidebar-ui.js?v=20260517-app-ui-split",
  "/app-composer-send-ui.js?v=20260517-app-ui-split",
  "/app-wire-start-ui.js?v=20260517-app-ui-split",
  "/app-start.js?v=20260517-app-ui-split",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-app-ui-split",
  "/file-viewer.html",
