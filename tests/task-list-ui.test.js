...
const CLIENT_VERSION = "20260609-global-plugin-dock-codex-frame-lift-v670";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260609-global-plugin-dock-codex-frame-lift-v670" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260609-global-plugin-dock-codex-frame-lift-v670"><\/noscript>/);
...
assert.match(stylesCss, /\.codex-mode\.embedded-plugin-host-active\.global-plugin-dock-collapsed-mode \.embedded-plugin-host \{[\s\S]*?padding-bottom: calc\(var\(--topic-plugin-dock-collapsed-height\) \+ 6px\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260609-global-plugin-dock-codex-frame-lift-v670/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260609-global-plugin-dock-codex-frame-lift-v670/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260609-global-plugin-dock-codex-frame-lift-v670/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260609-global-plugin-dock-codex-frame-lift-v670/);
