...
assert.match(navigationSearchUi, /updateBottomNavLabel\("bottomTasksMode", pluginContextNav \? "话题" : ""\)/);
assert.match(navigationSearchUi, /updateBottomNavLabel\("bottomProjectsMode", pluginContextNav \? "目录" : ""\)/);
assert.match(navigationSearchUi, /const pluginContextBottomTabs = new Set\(externalPluginContextNav[\s\S]*?\? \["bottomTasksMode", "bottomProjectsMode", pluginContextButtonId\][\s\S]*?: \["bottomTasksMode", "bottomProjectsMode"\]\)/);
...
assert.match(navigationSearchUi, /document\.querySelectorAll\("\.bottom-tab"\)\.forEach\(\(node\) => \{[\s\S]*?const visible = pluginContextBottomTabs\.has\(node\.id\);[\s\S]*?setBottomTabHidden\(node, !visible\);/);
assert.match(navigationSearchUi, /pluginContextBottomTabs\.forEach\(\(id\) => \{/);
