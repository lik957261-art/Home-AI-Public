...
const HERMES_SW_VERSION = "20260612-plugin-preference-restore-v721";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260612-plugin-preference-restore-v721",
  "/markdown-viewer.html?v=20260612-plugin-preference-restore-v721",
  "/app-task-artifact-helpers.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-story-helpers.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-reading-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-coins-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-program-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-task-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-reflection-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-api-client.js?v=20260612-plugin-preference-restore-v721",
  "/app.js?v=20260612-plugin-preference-restore-v721",
  "/app-shell-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-task-groups-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-navigation-view-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-chat-composer-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-composer-source-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-composer-context-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-run-progress-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-navigation-search-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-task-preview-helpers-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-task-preview-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-sidebar-task-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-message-skill-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-message-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-route-snapshot-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-platform-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-platform-status-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-pwa-settings-push-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-pwa-push-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-workspace-admin-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-access-key-manager-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-plugin-admin-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-share-image-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-draft-thread-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-directory-automation-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-shared-directory-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-embedded-plugin-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-wardrobe-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-plugin-topics-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-directory-topics-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-action-inbox-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-automation-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-native-growth-submission-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-ai-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-reward-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-settings-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-teaching-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-learning-growth-controller.js?v=20260612-plugin-preference-restore-v721",
  "/app-automation-controller-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-automation-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-thread-state-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-group-topic-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-core-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-story-core-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-todo-core-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-render-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-list-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-learning-panel-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-recorder-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-todo-detail-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-composer-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-card-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-kanban-study-actions-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-thread-message-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-thread-list-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-thread-directory-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-thread-card-message-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-long-message-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-rich-text-directory-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-message-usage-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-events-composer-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-event-stream-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-upload-sidebar-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-composer-send-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-wire-start-ui.js?v=20260612-plugin-preference-restore-v721",
  "/app-start.js?v=20260612-plugin-preference-restore-v721",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260612-plugin-preference-restore-v721",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
