...
function testServiceFirstArchitectureContract() {
  ...
  assert.ok(runtimeLineCount <= 1370, `mobile-server-runtime.js line budget exceeded: ${runtimeLineCount} > 1370`);
  assert.ok(runtimeTopLevelFunctionCount <= 16, `mobile-server-runtime.js top-level function budget exceeded: ${runtimeTopLevelFunctionCount} > 16`);
