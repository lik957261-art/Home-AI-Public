...
export WHISPER_INITIAL_PROMPT="${WHISPER_INITIAL_PROMPT:-以下是普通话语音转写，请使用简体中文，并加入合适的中文标点符号。}"
export WHISPER_CONDITION_ON_PREVIOUS_TEXT="${WHISPER_CONDITION_ON_PREVIOUS_TEXT:-1}"
export WHISPER_VAD_FILTER="${WHISPER_VAD_FILTER:-0}"
