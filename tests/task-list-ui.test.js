...
const CLIENT_VERSION = "20260523-group-state-hotfix-v97";
const appJs = [
...
assert.match(indexHtml, /app-codex-mux-ui\.js\?v=20260523-group-state-hotfix-v97/);
assert.match(serviceWorkerJs, /app-codex-mux-ui\.js\?v=20260523-group-state-hotfix-v97/);
