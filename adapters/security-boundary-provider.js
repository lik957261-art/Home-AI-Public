...
function permissionBoundarySkillInstructions(policy = {}) {
  ...
  return [
    ...
    "PowerPoint PPTX generation inside the current allowed roots is ordinary low-permission file delivery when the run has the file toolset; call `pptx_create` for explicit real .pptx deck requests and return its `MEDIA:<path>` line.",
