...
function createMobileSqliteStore(options = {}) {
  ...
  function upsertActionInboxItem(input = {}) {
    ...
    const requestedBefore = requestedId ? getActionInboxItem(requestedId) : null;
    const dedupeBefore = dedupeKey ? getActionInboxItemByDedupe(workspaceId, dedupeKey) : null;
    const before = requestedBefore || dedupeBefore;
