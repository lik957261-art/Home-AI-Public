...
const CLIENT_VERSION = "20260528-inbox-status-runprogress-v311";
const appJs = [
...
assert.match(indexHtml, /<meta name="theme-color" content="#17212a">/);
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260528-inbox-status-runprogress-v311/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260528-inbox-status-runprogress-v311/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260528-inbox-status-runprogress-v311/);
