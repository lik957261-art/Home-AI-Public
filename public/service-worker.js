...
const HERMES_SW_VERSION = "20260517-learning-launch-ops";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-learning-launch-ops",
  "/app-task-artifact-helpers.js?v=20260517-learning-launch-ops",
  "/app-kanban-story-helpers.js?v=20260517-learning-launch-ops",
  "/app-learning-reading-ui.js?v=20260517-learning-launch-ops",
  "/app-learning-coins-ui.js?v=20260517-learning-launch-ops",
  "/app-learning-program-ui.js?v=20260517-learning-launch-ops",
  "/app-learning-growth-ui.js?v=20260517-learning-launch-ops",
  "/app-api-client.js?v=20260517-learning-launch-ops",
  "/app.js?v=20260517-learning-launch-ops",
  "/app-shell-ui.js?v=20260517-learning-launch-ops",
  "/app-task-groups-ui.js?v=20260517-learning-launch-ops",
  "/app-chat-composer-ui.js?v=20260517-learning-launch-ops",
  "/app-composer-context-ui.js?v=20260517-learning-launch-ops",
  "/app-run-progress-ui.js?v=20260517-learning-launch-ops",
  "/app-navigation-search-ui.js?v=20260517-learning-launch-ops",
  "/app-sidebar-task-ui.js?v=20260517-learning-launch-ops",
  "/app-message-actions-ui.js?v=20260517-learning-launch-ops",
  "/app-platform-ui.js?v=20260517-learning-launch-ops",
  "/app-pwa-settings-push-ui.js?v=20260517-learning-launch-ops",
  "/app-workspace-admin-ui.js?v=20260517-learning-launch-ops",
  "/app-access-key-manager-ui.js?v=20260517-learning-launch-ops",
  "/app-share-image-ui.js?v=20260517-learning-launch-ops",
  "/app-draft-thread-ui.js?v=20260517-learning-launch-ops",
  "/app-directory-automation-ui.js?v=20260517-learning-launch-ops",
  "/app-shared-directory-ui.js?v=20260517-learning-launch-ops",
  "/app-automation-ui.js?v=20260517-learning-launch-ops",
  "/app-learning-growth-controller.js?v=20260517-learning-launch-ops",
  "/app-automation-controller-ui.js?v=20260517-learning-launch-ops",
  "/app-thread-state-ui.js?v=20260517-learning-launch-ops",
  "/app-group-topic-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-core-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-story-core-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-todo-core-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-render-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-list-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-learning-panel-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-recorder-ui.js?v=20260517-learning-launch-ops",
  "/app-todo-detail-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-actions-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-composer-actions-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-card-actions-ui.js?v=20260517-learning-launch-ops",
  "/app-kanban-study-actions-ui.js?v=20260517-learning-launch-ops",
  "/app-thread-message-ui.js?v=20260517-learning-launch-ops",
  "/app-thread-list-ui.js?v=20260517-learning-launch-ops",
  "/app-thread-directory-ui.js?v=20260517-learning-launch-ops",
  "/app-thread-card-message-ui.js?v=20260517-learning-launch-ops",
  "/app-rich-text-directory-ui.js?v=20260517-learning-launch-ops",
  "/app-message-usage-ui.js?v=20260517-learning-launch-ops",
  "/app-events-composer-ui.js?v=20260517-learning-launch-ops",
  "/app-event-stream-ui.js?v=20260517-learning-launch-ops",
  "/app-upload-sidebar-ui.js?v=20260517-learning-launch-ops",
  "/app-composer-send-ui.js?v=20260517-learning-launch-ops",
  "/app-wire-start-ui.js?v=20260517-learning-launch-ops",
  "/app-start.js?v=20260517-learning-launch-ops",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-learning-launch-ops",
  "/file-viewer.html",
