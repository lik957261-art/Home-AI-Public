...
assert.match(appJs, /<a class="artifact-card doc-\$\{escapeHtml\(artifactKind\(artifact\)\)\}" href="\$\{escapeHtml\(artifactHref\(artifact\)\)\}" data-task-doc>/);
assert.match(appJs, /<a class="task-doc-icon doc-\$\{escapeHtml\(artifactKind\(latestArtifact\)\)\}" href="\$\{escapeHtml\(artifactHref\(latestArtifact\)\)\}" data-task-doc/);
assert.doesNotMatch(appJs, /data-task-doc[^>]*target="_blank"/);
...
assert.match(fileViewer, /location\.replace\(original\)/);
