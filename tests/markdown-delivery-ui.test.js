...
const artifactFacadeService = fs.readFileSync(path.join(repoRoot, "adapters", "mobile-runtime-artifact-facade-service.js"), "utf8");
...
const webPushAutomationProjectionServiceJs = fs.readFileSync(path.join(repoRoot, "adapters", "web-push-automation-projection-service.js"), "utf8");
...
assert.match(webPushAutomationProjectionServiceJs, /automationDeliverableExtensions[\s\S]*\["\.md", "\.pdf", "\.doc", "\.docx", "\.xlsx", "\.pptx"\]/);
...
assert.match(serverJs, /const artifactMethod = \(methodName\) => \(\.\.\.args\) => artifactFacade\(\)\[methodName\]\(\.\.\.args\)/);
assert.match(serverJs, /compactArtifactsForMessage/);
assert.match(serverJs, /attachUploadedArtifactsToMessage/);
assert.match(artifactFacadeService, /attachUploadedArtifactsToMessage: \(\.\.\.args\) => fileArtifact\("attachUploadedArtifactsToMessage", args\)/);
...
assert.match(serverJs, /workspaceUploadDirectoryForRequest/);
assert.match(artifactFacadeService, /workspaceUploadDirectoryForRequest: \(\.\.\.args\) => fileArtifact\("workspaceUploadDirectoryForRequest", args\)/);
...
assert.match(artifactFacadeService, /defaultCreateArtifactTextRegistrationService/);
assert.match(artifactFacadeService, /compactArtifactsForMessage: \(\.\.\.args\) => textArtifact\("compactArtifactsForMessage", args\)/);
assert.match(artifactFacadeService, /findSourceMarkdownForArtifact: \(\.\.\.args\) => textArtifact\("findSourceMarkdownForArtifact", args\)/);
