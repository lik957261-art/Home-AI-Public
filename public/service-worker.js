...
const HERMES_SW_VERSION = "20260517-growth-workbench-nav";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-growth-workbench-nav",
  "/app-task-artifact-helpers.js?v=20260517-growth-workbench-nav",
  "/app-kanban-story-helpers.js?v=20260517-growth-workbench-nav",
  "/app-learning-reading-ui.js?v=20260517-growth-workbench-nav",
  "/app-learning-coins-ui.js?v=20260517-growth-workbench-nav",
  "/app-learning-program-ui.js?v=20260517-growth-workbench-nav",
  "/app-learning-growth-ui.js?v=20260517-growth-workbench-nav",
  "/app-api-client.js?v=20260517-growth-workbench-nav",
  "/app.js?v=20260517-growth-workbench-nav",
  "/app-shell-ui.js?v=20260517-growth-workbench-nav",
  "/app-task-groups-ui.js?v=20260517-growth-workbench-nav",
  "/app-chat-composer-ui.js?v=20260517-growth-workbench-nav",
  "/app-composer-context-ui.js?v=20260517-growth-workbench-nav",
  "/app-run-progress-ui.js?v=20260517-growth-workbench-nav",
  "/app-navigation-search-ui.js?v=20260517-growth-workbench-nav",
  "/app-sidebar-task-ui.js?v=20260517-growth-workbench-nav",
  "/app-message-actions-ui.js?v=20260517-growth-workbench-nav",
  "/app-platform-ui.js?v=20260517-growth-workbench-nav",
  "/app-pwa-settings-push-ui.js?v=20260517-growth-workbench-nav",
  "/app-workspace-admin-ui.js?v=20260517-growth-workbench-nav",
  "/app-access-key-manager-ui.js?v=20260517-growth-workbench-nav",
  "/app-share-image-ui.js?v=20260517-growth-workbench-nav",
  "/app-draft-thread-ui.js?v=20260517-growth-workbench-nav",
  "/app-directory-automation-ui.js?v=20260517-growth-workbench-nav",
  "/app-shared-directory-ui.js?v=20260517-growth-workbench-nav",
  "/app-automation-ui.js?v=20260517-growth-workbench-nav",
  "/app-learning-growth-controller.js?v=20260517-growth-workbench-nav",
  "/app-automation-controller-ui.js?v=20260517-growth-workbench-nav",
  "/app-thread-state-ui.js?v=20260517-growth-workbench-nav",
  "/app-group-topic-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-core-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-story-core-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-todo-core-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-render-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-list-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-learning-panel-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-recorder-ui.js?v=20260517-growth-workbench-nav",
  "/app-todo-detail-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-actions-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-composer-actions-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-card-actions-ui.js?v=20260517-growth-workbench-nav",
  "/app-kanban-study-actions-ui.js?v=20260517-growth-workbench-nav",
  "/app-thread-message-ui.js?v=20260517-growth-workbench-nav",
  "/app-thread-list-ui.js?v=20260517-growth-workbench-nav",
  "/app-thread-directory-ui.js?v=20260517-growth-workbench-nav",
  "/app-thread-card-message-ui.js?v=20260517-growth-workbench-nav",
  "/app-rich-text-directory-ui.js?v=20260517-growth-workbench-nav",
  "/app-message-usage-ui.js?v=20260517-growth-workbench-nav",
  "/app-events-composer-ui.js?v=20260517-growth-workbench-nav",
  "/app-event-stream-ui.js?v=20260517-growth-workbench-nav",
  "/app-upload-sidebar-ui.js?v=20260517-growth-workbench-nav",
  "/app-composer-send-ui.js?v=20260517-growth-workbench-nav",
  "/app-wire-start-ui.js?v=20260517-growth-workbench-nav",
  "/app-start.js?v=20260517-growth-workbench-nav",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-growth-workbench-nav",
  "/file-viewer.html",
