...
const CLIENT_VERSION = "20260618-composer-send-lock-v846";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260618-composer-send-lock-v846" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260618-composer-send-lock-v846"><\/noscript>/);
...
assert.match(stylesCss, /\.message\.assistant\.streaming-active \.message-body \{[\s\S]*?max-height: min\(calc\(var\(--app-viewport-height, 100dvh\) - 128px\), 680px\);[\s\S]*?overflow: hidden;/);
assert.match(stylesCss, /\.message\.assistant\.streaming-active \.run-progress-panel\.inline \{[\s\S]*?max-height: min\(36dvh, 272px\);[\s\S]*?padding-bottom: 12px;[\s\S]*?overflow: hidden;/);
assert.match(stylesCss, /\.message\.assistant\.streaming-active \.run-progress-panel\.inline \.run-progress-rows \{[\s\S]*?max-height: min\(25dvh, 182px\);[\s\S]*?padding-bottom: 2px;[\s\S]*?overflow: hidden;/);
assert.match(stylesCss, /\.assistant-streaming-receipt-text \{[\s\S]*?-webkit-line-clamp: 6;[\s\S]*?white-space: pre-wrap;/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(indexHtml, /app-voice-input-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(serviceWorkerJs, /\/app-voice-input-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(indexHtml, /app-voice-learning-ui\.js\?v=20260618-composer-send-lock-v846/);
assert.match(serviceWorkerJs, /\/app-voice-learning-ui\.js\?v=20260618-composer-send-lock-v846/);
...
assert.match(appJs, /pluginTopicRecentMessageEntries\(def, options\.thread \|\| state\.currentThread, 1, \{ max: 120 \}\)/);
