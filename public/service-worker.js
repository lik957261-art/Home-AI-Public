...
const HERMES_SW_VERSION = "20260614-plugin-audit-v768";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260614-plugin-audit-v768",
  "/markdown-viewer.html?v=20260614-plugin-audit-v768",
  "/app-task-artifact-helpers.js?v=20260614-plugin-audit-v768",
  "/app-kanban-story-helpers.js?v=20260614-plugin-audit-v768",
  "/app-learning-reading-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-coins-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-program-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-task-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-reflection-ui.js?v=20260614-plugin-audit-v768",
  "/app-api-client.js?v=20260614-plugin-audit-v768",
  "/app.js?v=20260614-plugin-audit-v768",
  "/app-shell-ui.js?v=20260614-plugin-audit-v768",
  "/app-task-groups-ui.js?v=20260614-plugin-audit-v768",
  "/app-navigation-view-ui.js?v=20260614-plugin-audit-v768",
  "/app-chat-composer-ui.js?v=20260614-plugin-audit-v768",
  "/app-composer-source-ui.js?v=20260614-plugin-audit-v768",
  "/app-composer-context-ui.js?v=20260614-plugin-audit-v768",
  "/app-run-progress-ui.js?v=20260614-plugin-audit-v768",
  "/app-navigation-search-ui.js?v=20260614-plugin-audit-v768",
  "/app-task-preview-helpers-ui.js?v=20260614-plugin-audit-v768",
  "/app-task-preview-ui.js?v=20260614-plugin-audit-v768",
  "/app-sidebar-task-ui.js?v=20260614-plugin-audit-v768",
  "/app-message-skill-ui.js?v=20260614-plugin-audit-v768",
  "/app-message-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-route-snapshot-ui.js?v=20260614-plugin-audit-v768",
  "/app-platform-ui.js?v=20260614-plugin-audit-v768",
  "/app-platform-status-ui.js?v=20260614-plugin-audit-v768",
  "/app-pwa-settings-push-ui.js?v=20260614-plugin-audit-v768",
  "/app-pwa-push-ui.js?v=20260614-plugin-audit-v768",
  "/app-workspace-admin-ui.js?v=20260614-plugin-audit-v768",
  "/app-access-key-manager-ui.js?v=20260614-plugin-audit-v768",
  "/app-plugin-admin-ui.js?v=20260614-plugin-audit-v768",
  "/app-share-image-ui.js?v=20260614-plugin-audit-v768",
  "/app-draft-thread-ui.js?v=20260614-plugin-audit-v768",
  "/app-directory-automation-ui.js?v=20260614-plugin-audit-v768",
  "/app-shared-directory-ui.js?v=20260614-plugin-audit-v768",
  "/app-embedded-plugin-ui.js?v=20260614-plugin-audit-v768",
  "/app-wardrobe-ui.js?v=20260614-plugin-audit-v768",
  "/app-plugin-topics-ui.js?v=20260614-plugin-audit-v768",
  "/app-directory-topics-ui.js?v=20260614-plugin-audit-v768",
  "/app-action-inbox-ui.js?v=20260614-plugin-audit-v768",
  "/app-automation-ui.js?v=20260614-plugin-audit-v768",
  "/app-learning-native-growth-submission-controller.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-ai-controller.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-reward-controller.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-settings-controller.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-teaching-controller.js?v=20260614-plugin-audit-v768",
  "/app-learning-growth-controller.js?v=20260614-plugin-audit-v768",
  "/app-automation-controller-ui.js?v=20260614-plugin-audit-v768",
  "/app-automation-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-thread-state-ui.js?v=20260614-plugin-audit-v768",
  "/app-group-topic-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-core-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-story-core-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-todo-core-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-render-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-list-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-learning-panel-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-recorder-ui.js?v=20260614-plugin-audit-v768",
  "/app-todo-detail-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-composer-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-card-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-kanban-study-actions-ui.js?v=20260614-plugin-audit-v768",
  "/app-thread-message-ui.js?v=20260614-plugin-audit-v768",
  "/app-thread-list-ui.js?v=20260614-plugin-audit-v768",
  "/app-thread-directory-ui.js?v=20260614-plugin-audit-v768",
  "/app-thread-card-message-ui.js?v=20260614-plugin-audit-v768",
  "/app-long-message-ui.js?v=20260614-plugin-audit-v768",
  "/app-rich-text-directory-ui.js?v=20260614-plugin-audit-v768",
  "/app-message-usage-ui.js?v=20260614-plugin-audit-v768",
  "/app-events-composer-ui.js?v=20260614-plugin-audit-v768",
  "/app-event-stream-ui.js?v=20260614-plugin-audit-v768",
  "/app-upload-sidebar-ui.js?v=20260614-plugin-audit-v768",
  "/app-composer-send-ui.js?v=20260614-plugin-audit-v768",
  "/app-voice-input-ui.js?v=20260614-plugin-audit-v768",
  "/app-voice-learning-ui.js?v=20260614-plugin-audit-v768",
  "/app-wire-start-ui.js?v=20260614-plugin-audit-v768",
  "/app-start.js?v=20260614-plugin-audit-v768",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260614-plugin-audit-v768",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
