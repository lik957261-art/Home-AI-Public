...
const CLIENT_VERSION = "20260529-plugin-back-result-v350";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260529-plugin-back-result-v350/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260529-plugin-back-result-v350/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260529-plugin-back-result-v350/);
