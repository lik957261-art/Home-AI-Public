...
const HERMES_SW_VERSION = "20260519-freeze-guard-v9";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260519-freeze-guard-v9",
  "/app-task-artifact-helpers.js?v=20260519-freeze-guard-v9",
  "/app-kanban-story-helpers.js?v=20260519-freeze-guard-v9",
  "/app-learning-reading-ui.js?v=20260519-freeze-guard-v9",
  "/app-learning-coins-ui.js?v=20260519-freeze-guard-v9",
  "/app-learning-program-ui.js?v=20260519-freeze-guard-v9",
  "/app-learning-growth-ui.js?v=20260519-freeze-guard-v9",
  "/app-learning-growth-task-ui.js?v=20260519-freeze-guard-v9",
  "/app-api-client.js?v=20260519-freeze-guard-v9",
  "/app.js?v=20260519-freeze-guard-v9",
  "/app-shell-ui.js?v=20260519-freeze-guard-v9",
  "/app-task-groups-ui.js?v=20260519-freeze-guard-v9",
  "/app-chat-composer-ui.js?v=20260519-freeze-guard-v9",
  "/app-composer-source-ui.js?v=20260519-freeze-guard-v9",
  "/app-composer-context-ui.js?v=20260519-freeze-guard-v9",
  "/app-run-progress-ui.js?v=20260519-freeze-guard-v9",
  "/app-navigation-search-ui.js?v=20260519-freeze-guard-v9",
  "/app-sidebar-task-ui.js?v=20260519-freeze-guard-v9",
  "/app-message-skill-ui.js?v=20260519-freeze-guard-v9",
  "/app-message-actions-ui.js?v=20260519-freeze-guard-v9",
  "/app-platform-ui.js?v=20260519-freeze-guard-v9",
  "/app-pwa-settings-push-ui.js?v=20260519-freeze-guard-v9",
  "/app-workspace-admin-ui.js?v=20260519-freeze-guard-v9",
  "/app-access-key-manager-ui.js?v=20260519-freeze-guard-v9",
  "/app-share-image-ui.js?v=20260519-freeze-guard-v9",
  "/app-draft-thread-ui.js?v=20260519-freeze-guard-v9",
  "/app-directory-automation-ui.js?v=20260519-freeze-guard-v9",
  "/app-shared-directory-ui.js?v=20260519-freeze-guard-v9",
  "/app-automation-ui.js?v=20260519-freeze-guard-v9",
  "/app-learning-growth-controller.js?v=20260519-freeze-guard-v9",
  "/app-automation-controller-ui.js?v=20260519-freeze-guard-v9",
  "/app-thread-state-ui.js?v=20260519-freeze-guard-v9",
  "/app-group-topic-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-core-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-story-core-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-todo-core-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-render-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-list-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-learning-panel-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-recorder-ui.js?v=20260519-freeze-guard-v9",
  "/app-todo-detail-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-actions-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-composer-actions-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-card-actions-ui.js?v=20260519-freeze-guard-v9",
  "/app-kanban-study-actions-ui.js?v=20260519-freeze-guard-v9",
  "/app-thread-message-ui.js?v=20260519-freeze-guard-v9",
  "/app-thread-list-ui.js?v=20260519-freeze-guard-v9",
  "/app-thread-directory-ui.js?v=20260519-freeze-guard-v9",
  "/app-thread-card-message-ui.js?v=20260519-freeze-guard-v9",
  "/app-long-message-ui.js?v=20260519-freeze-guard-v9",
  "/app-rich-text-directory-ui.js?v=20260519-freeze-guard-v9",
  "/app-message-usage-ui.js?v=20260519-freeze-guard-v9",
  "/app-events-composer-ui.js?v=20260519-freeze-guard-v9",
  "/app-event-stream-ui.js?v=20260519-freeze-guard-v9",
  "/app-upload-sidebar-ui.js?v=20260519-freeze-guard-v9",
  "/app-composer-send-ui.js?v=20260519-freeze-guard-v9",
  "/app-wire-start-ui.js?v=20260519-freeze-guard-v9",
  "/app-start.js?v=20260519-freeze-guard-v9",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260519-freeze-guard-v9",
  "/file-viewer.html",
