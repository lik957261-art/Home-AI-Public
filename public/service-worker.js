...
const HERMES_SW_VERSION = "20260601-plugin-workspace-frame-v416";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/index.html",
  "/client-reset.html",
  "/styles.css?v=20260601-plugin-workspace-frame-v416",
  "/markdown-viewer.html?v=20260601-plugin-workspace-frame-v416",
  "/app-task-artifact-helpers.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-story-helpers.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-reading-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-coins-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-program-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-task-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-reflection-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-api-client.js?v=20260601-plugin-workspace-frame-v416",
  "/app.js?v=20260601-plugin-workspace-frame-v416",
  "/app-shell-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-task-groups-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-navigation-view-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-chat-composer-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-composer-source-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-composer-context-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-run-progress-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-navigation-search-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-task-preview-helpers-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-task-preview-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-sidebar-task-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-message-skill-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-message-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-platform-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-platform-status-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-pwa-settings-push-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-pwa-push-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-workspace-admin-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-access-key-manager-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-plugin-admin-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-share-image-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-draft-thread-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-directory-automation-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-shared-directory-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-embedded-plugin-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-wardrobe-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-action-inbox-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-automation-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-native-growth-submission-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-ai-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-reward-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-settings-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-teaching-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-learning-growth-controller.js?v=20260601-plugin-workspace-frame-v416",
  "/app-automation-controller-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-automation-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-thread-state-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-group-topic-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-core-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-story-core-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-todo-core-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-render-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-list-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-learning-panel-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-recorder-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-todo-detail-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-composer-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-card-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-kanban-study-actions-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-thread-message-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-thread-list-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-thread-directory-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-thread-card-message-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-long-message-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-rich-text-directory-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-message-usage-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-events-composer-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-event-stream-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-upload-sidebar-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-composer-send-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-wire-start-ui.js?v=20260601-plugin-workspace-frame-v416",
  "/app-start.js?v=20260601-plugin-workspace-frame-v416",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260601-plugin-workspace-frame-v416",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
