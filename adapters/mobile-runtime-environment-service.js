...
function createMobileRuntimeEnvironment(options = {}) {
  ...
  const GATEWAY_MODEL_PERMISSION_PREFLIGHT_ENABLED = !/^(0|false|no|off)$/i.test(env.HERMES_MOBILE_GATEWAY_MODEL_PERMISSION_PREFLIGHT || env.HERMES_WEB_GATEWAY_MODEL_PERMISSION_PREFLIGHT || "1");
