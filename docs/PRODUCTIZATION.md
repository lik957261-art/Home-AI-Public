...
- Provider boundaries are now in place for workspace/project catalog loading and Todo operations. Continue by moving shared-directory expansion, project-root discovery, workspace external-integration inventory, and automation/CRON operations behind provider methods.
- Target shape:
