...
const CLIENT_VERSION = "20260529-wardrobe-plugin-navigation-v344";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260529-wardrobe-plugin-navigation-v344/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260529-wardrobe-plugin-navigation-v344/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260529-wardrobe-plugin-navigation-v344/);
...
assert.match(appJs, /"chatManagementMode", "taskManagementMode", "singleMode", "singleTaskMode", "tasksMode", "projectsMode", "todosMode", "automationMode", "bottomChatMode", "bottomInboxMode", "bottomTasksMode", "bottomProjectsMode", "bottomTodosMode", "bottomWardrobeMode", "bottomAutomationMode"/);
...
assert.match(indexHtml, /id="bottomChatMode"[\s\S]*id="bottomTasksMode"[\s\S]*id="bottomInboxMode"[\s\S]*id="bottomProjectsMode"[\s\S]*id="bottomWardrobeMode"[\s\S]*id="bottomTodosMode"/);
