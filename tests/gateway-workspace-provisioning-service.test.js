...
function testExistingWorkspaceRepairsMacProfilePathsAndWorkerKeys() {
  withManifest({
    ...
    assert.equal(openai.configPath, "/Users/hm-codex-disposable-20260608a/HermesWorkspace/.hermes-gateway/profiles/lowgw41/config.yaml");
    assert.equal(deepseek.configPath, "/Users/hm-codex-disposable-20260608a/HermesWorkspace/.hermes-gateway/profiles/deepseekgw41/config.yaml");
