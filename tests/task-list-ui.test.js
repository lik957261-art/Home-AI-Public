...
assert.ok(indexHtml.includes("20260511-1245"));
assert.ok(serviceWorkerJs.includes("20260511-shared-directory-badge"));
...
assert.match(appJs, /\/api\/todos\/\$\{encodeURIComponent\(todoId\)\}\/comment/);
