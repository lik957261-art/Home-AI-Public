...
const HERMES_SW_VERSION = "20260517-growth-kanban-tasks";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-growth-kanban-tasks",
  "/app-task-artifact-helpers.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-story-helpers.js?v=20260517-growth-kanban-tasks",
  "/app-learning-reading-ui.js?v=20260517-growth-kanban-tasks",
  "/app-learning-coins-ui.js?v=20260517-growth-kanban-tasks",
  "/app-learning-program-ui.js?v=20260517-growth-kanban-tasks",
  "/app-learning-growth-ui.js?v=20260517-growth-kanban-tasks",
  "/app-api-client.js?v=20260517-growth-kanban-tasks",
  "/app.js?v=20260517-growth-kanban-tasks",
  "/app-shell-ui.js?v=20260517-growth-kanban-tasks",
  "/app-task-groups-ui.js?v=20260517-growth-kanban-tasks",
  "/app-chat-composer-ui.js?v=20260517-growth-kanban-tasks",
  "/app-composer-context-ui.js?v=20260517-growth-kanban-tasks",
  "/app-run-progress-ui.js?v=20260517-growth-kanban-tasks",
  "/app-navigation-search-ui.js?v=20260517-growth-kanban-tasks",
  "/app-sidebar-task-ui.js?v=20260517-growth-kanban-tasks",
  "/app-message-actions-ui.js?v=20260517-growth-kanban-tasks",
  "/app-platform-ui.js?v=20260517-growth-kanban-tasks",
  "/app-pwa-settings-push-ui.js?v=20260517-growth-kanban-tasks",
  "/app-workspace-admin-ui.js?v=20260517-growth-kanban-tasks",
  "/app-access-key-manager-ui.js?v=20260517-growth-kanban-tasks",
  "/app-share-image-ui.js?v=20260517-growth-kanban-tasks",
  "/app-draft-thread-ui.js?v=20260517-growth-kanban-tasks",
  "/app-directory-automation-ui.js?v=20260517-growth-kanban-tasks",
  "/app-shared-directory-ui.js?v=20260517-growth-kanban-tasks",
  "/app-automation-ui.js?v=20260517-growth-kanban-tasks",
  "/app-learning-growth-controller.js?v=20260517-growth-kanban-tasks",
  "/app-automation-controller-ui.js?v=20260517-growth-kanban-tasks",
  "/app-thread-state-ui.js?v=20260517-growth-kanban-tasks",
  "/app-group-topic-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-core-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-story-core-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-todo-core-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-render-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-list-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-learning-panel-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-recorder-ui.js?v=20260517-growth-kanban-tasks",
  "/app-todo-detail-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-actions-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-composer-actions-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-card-actions-ui.js?v=20260517-growth-kanban-tasks",
  "/app-kanban-study-actions-ui.js?v=20260517-growth-kanban-tasks",
  "/app-thread-message-ui.js?v=20260517-growth-kanban-tasks",
  "/app-thread-list-ui.js?v=20260517-growth-kanban-tasks",
  "/app-thread-directory-ui.js?v=20260517-growth-kanban-tasks",
  "/app-thread-card-message-ui.js?v=20260517-growth-kanban-tasks",
  "/app-rich-text-directory-ui.js?v=20260517-growth-kanban-tasks",
  "/app-message-usage-ui.js?v=20260517-growth-kanban-tasks",
  "/app-events-composer-ui.js?v=20260517-growth-kanban-tasks",
  "/app-event-stream-ui.js?v=20260517-growth-kanban-tasks",
  "/app-upload-sidebar-ui.js?v=20260517-growth-kanban-tasks",
  "/app-composer-send-ui.js?v=20260517-growth-kanban-tasks",
  "/app-wire-start-ui.js?v=20260517-growth-kanban-tasks",
  "/app-start.js?v=20260517-growth-kanban-tasks",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-growth-kanban-tasks",
  "/file-viewer.html",
