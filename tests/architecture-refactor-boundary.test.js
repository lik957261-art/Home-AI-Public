...
function testServiceFirstArchitectureContract() {
  ...
  assert.match(doc, /1,960 lines/);
  assert.match(doc, /175/);
  ...
  assert.ok(runtimeLineCount <= 1960, `mobile-server-runtime.js line budget exceeded: ${runtimeLineCount} > 1960`);
  assert.ok(runtimeTopLevelFunctionCount <= 175, `mobile-server-runtime.js top-level function budget exceeded: ${runtimeTopLevelFunctionCount} > 175`);
