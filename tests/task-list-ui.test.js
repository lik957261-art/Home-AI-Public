...
assert.ok(indexHtml.includes("20260513-0105"));
assert.ok(serviceWorkerJs.includes("20260513-weixin-file-forward"));
...
assert.match(serverJs, /function weixinIngressThreadForEvent\(event, workspaceId\) \{\s+return ensureSingleWindowThread\(workspaceId\);\s+\}/);
