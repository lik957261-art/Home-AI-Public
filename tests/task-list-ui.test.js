...
const CLIENT_VERSION = "20260527-same-window-nav-v267";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260527-same-window-nav-v267/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260527-same-window-nav-v267/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260527-same-window-nav-v267/);
