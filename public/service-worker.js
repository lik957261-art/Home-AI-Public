...
const HERMES_SW_VERSION = "20260519-skill-fix-v12";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260519-skill-fix-v12",
  "/app-task-artifact-helpers.js?v=20260519-skill-fix-v12",
  "/app-kanban-story-helpers.js?v=20260519-skill-fix-v12",
  "/app-learning-reading-ui.js?v=20260519-skill-fix-v12",
  "/app-learning-coins-ui.js?v=20260519-skill-fix-v12",
  "/app-learning-program-ui.js?v=20260519-skill-fix-v12",
  "/app-learning-growth-ui.js?v=20260519-skill-fix-v12",
  "/app-learning-growth-task-ui.js?v=20260519-skill-fix-v12",
  "/app-api-client.js?v=20260519-skill-fix-v12",
  "/app.js?v=20260519-skill-fix-v12",
  "/app-shell-ui.js?v=20260519-skill-fix-v12",
  "/app-task-groups-ui.js?v=20260519-skill-fix-v12",
  "/app-chat-composer-ui.js?v=20260519-skill-fix-v12",
  "/app-composer-source-ui.js?v=20260519-skill-fix-v12",
  "/app-composer-context-ui.js?v=20260519-skill-fix-v12",
  "/app-run-progress-ui.js?v=20260519-skill-fix-v12",
  "/app-navigation-search-ui.js?v=20260519-skill-fix-v12",
  "/app-sidebar-task-ui.js?v=20260519-skill-fix-v12",
  "/app-message-skill-ui.js?v=20260519-skill-fix-v12",
  "/app-message-actions-ui.js?v=20260519-skill-fix-v12",
  "/app-platform-ui.js?v=20260519-skill-fix-v12",
  "/app-pwa-settings-push-ui.js?v=20260519-skill-fix-v12",
  "/app-workspace-admin-ui.js?v=20260519-skill-fix-v12",
  "/app-access-key-manager-ui.js?v=20260519-skill-fix-v12",
  "/app-share-image-ui.js?v=20260519-skill-fix-v12",
  "/app-draft-thread-ui.js?v=20260519-skill-fix-v12",
  "/app-directory-automation-ui.js?v=20260519-skill-fix-v12",
  "/app-shared-directory-ui.js?v=20260519-skill-fix-v12",
  "/app-automation-ui.js?v=20260519-skill-fix-v12",
  "/app-learning-growth-controller.js?v=20260519-skill-fix-v12",
  "/app-automation-controller-ui.js?v=20260519-skill-fix-v12",
  "/app-thread-state-ui.js?v=20260519-skill-fix-v12",
  "/app-group-topic-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-core-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-story-core-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-todo-core-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-render-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-list-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-learning-panel-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-recorder-ui.js?v=20260519-skill-fix-v12",
  "/app-todo-detail-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-actions-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-composer-actions-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-card-actions-ui.js?v=20260519-skill-fix-v12",
  "/app-kanban-study-actions-ui.js?v=20260519-skill-fix-v12",
  "/app-thread-message-ui.js?v=20260519-skill-fix-v12",
  "/app-thread-list-ui.js?v=20260519-skill-fix-v12",
  "/app-thread-directory-ui.js?v=20260519-skill-fix-v12",
  "/app-thread-card-message-ui.js?v=20260519-skill-fix-v12",
  "/app-long-message-ui.js?v=20260519-skill-fix-v12",
  "/app-rich-text-directory-ui.js?v=20260519-skill-fix-v12",
  "/app-message-usage-ui.js?v=20260519-skill-fix-v12",
  "/app-events-composer-ui.js?v=20260519-skill-fix-v12",
  "/app-event-stream-ui.js?v=20260519-skill-fix-v12",
  "/app-upload-sidebar-ui.js?v=20260519-skill-fix-v12",
  "/app-composer-send-ui.js?v=20260519-skill-fix-v12",
  "/app-wire-start-ui.js?v=20260519-skill-fix-v12",
  "/app-start.js?v=20260519-skill-fix-v12",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260519-skill-fix-v12",
  "/file-viewer.html",
