...
const CLIENT_VERSION = "20260531-dark-theme-tone-v381";
const appJs = [
...
assert.match(indexHtml, /<style id="hermesInitialThemeStyle">[\s\S]*?html\[data-effective-theme="dark"\] \{[\s\S]*?background: #121518;[\s\S]*?color-scheme: dark;/);
...
assert.match(stylesCss, /:root\[data-theme="dark"\] \{[\s\S]*?color-scheme: dark;[\s\S]*?--ui-page: #121518;[\s\S]*?--ui-field-bg: rgba\(255, 255, 255, 0\.10\);[\s\S]*?--ui-card-surface: rgba\(30, 35, 39, 0\.84\);/);
