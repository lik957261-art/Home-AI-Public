...
const CLIENT_VERSION = "20260529-wardrobe-persistent-host-v346";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260529-wardrobe-persistent-host-v346/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260529-wardrobe-persistent-host-v346/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260529-wardrobe-persistent-host-v346/);
