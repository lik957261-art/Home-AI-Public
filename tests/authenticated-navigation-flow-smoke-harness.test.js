...
assert.match(script, /const appState = typeof state !== "undefined"/);
assert.match(script, /const pluginTopicActive = Boolean/);
assert.match(script, /chat: viewMode === "single" && !pluginTopicActive/);
assert.match(script, /plugin_or_topic: pluginTopicActive/);
assert.match(script, /return/);
assert.match(script, /action\?\.back/);
assert.match(script, /page\.goBack/);
