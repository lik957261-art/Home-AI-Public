...
const HERMES_SW_VERSION = "20260517-topic-bottom-jump";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-topic-bottom-jump",
  "/app-task-artifact-helpers.js?v=20260517-topic-bottom-jump",
  "/app-kanban-story-helpers.js?v=20260517-topic-bottom-jump",
  "/app-learning-reading-ui.js?v=20260517-topic-bottom-jump",
  "/app-learning-coins-ui.js?v=20260517-topic-bottom-jump",
  "/app-learning-program-ui.js?v=20260517-topic-bottom-jump",
  "/app-learning-growth-ui.js?v=20260517-topic-bottom-jump",
  "/app-api-client.js?v=20260517-topic-bottom-jump",
  "/app.js?v=20260517-topic-bottom-jump",
  "/app-shell-ui.js?v=20260517-topic-bottom-jump",
  "/app-task-groups-ui.js?v=20260517-topic-bottom-jump",
  "/app-chat-composer-ui.js?v=20260517-topic-bottom-jump",
  "/app-composer-context-ui.js?v=20260517-topic-bottom-jump",
  "/app-run-progress-ui.js?v=20260517-topic-bottom-jump",
  "/app-navigation-search-ui.js?v=20260517-topic-bottom-jump",
  "/app-sidebar-task-ui.js?v=20260517-topic-bottom-jump",
  "/app-message-actions-ui.js?v=20260517-topic-bottom-jump",
  "/app-platform-ui.js?v=20260517-topic-bottom-jump",
  "/app-pwa-settings-push-ui.js?v=20260517-topic-bottom-jump",
  "/app-workspace-admin-ui.js?v=20260517-topic-bottom-jump",
  "/app-access-key-manager-ui.js?v=20260517-topic-bottom-jump",
  "/app-share-image-ui.js?v=20260517-topic-bottom-jump",
  "/app-draft-thread-ui.js?v=20260517-topic-bottom-jump",
  "/app-directory-automation-ui.js?v=20260517-topic-bottom-jump",
  "/app-shared-directory-ui.js?v=20260517-topic-bottom-jump",
  "/app-automation-ui.js?v=20260517-topic-bottom-jump",
  "/app-learning-growth-controller.js?v=20260517-topic-bottom-jump",
  "/app-automation-controller-ui.js?v=20260517-topic-bottom-jump",
  "/app-thread-state-ui.js?v=20260517-topic-bottom-jump",
  "/app-group-topic-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-core-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-story-core-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-todo-core-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-render-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-list-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-learning-panel-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-recorder-ui.js?v=20260517-topic-bottom-jump",
  "/app-todo-detail-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-actions-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-composer-actions-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-card-actions-ui.js?v=20260517-topic-bottom-jump",
  "/app-kanban-study-actions-ui.js?v=20260517-topic-bottom-jump",
  "/app-thread-message-ui.js?v=20260517-topic-bottom-jump",
  "/app-thread-list-ui.js?v=20260517-topic-bottom-jump",
  "/app-thread-directory-ui.js?v=20260517-topic-bottom-jump",
  "/app-thread-card-message-ui.js?v=20260517-topic-bottom-jump",
  "/app-rich-text-directory-ui.js?v=20260517-topic-bottom-jump",
  "/app-message-usage-ui.js?v=20260517-topic-bottom-jump",
  "/app-events-composer-ui.js?v=20260517-topic-bottom-jump",
  "/app-event-stream-ui.js?v=20260517-topic-bottom-jump",
  "/app-upload-sidebar-ui.js?v=20260517-topic-bottom-jump",
  "/app-composer-send-ui.js?v=20260517-topic-bottom-jump",
  "/app-wire-start-ui.js?v=20260517-topic-bottom-jump",
  "/app-start.js?v=20260517-topic-bottom-jump",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-topic-bottom-jump",
  "/file-viewer.html",
