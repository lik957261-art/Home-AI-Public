...
const CLIENT_VERSION = "20260602-plugin-topic-composer-v495";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260602-plugin-topic-composer-v495" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260602-plugin-topic-composer-v495"><\/noscript>/);
...
assert.match(appJs, /configureComposer\(\{ enabled: false, hidden: true, placeholder: "Open a directory to bind a topic" \}\)/);
...
assert.match(appJs, /const pluginContextTarget = pluginContextBackTarget\(\)/);
assert.match(appJs, /if \(pluginContextTarget\) return pluginContextTarget;/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260602-plugin-topic-composer-v495/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260602-plugin-topic-composer-v495/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260602-plugin-topic-composer-v495/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260602-plugin-topic-composer-v495/);
