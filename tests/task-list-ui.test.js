...
const CLIENT_VERSION = "20260527-ios-pwa-route-guard-v269";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260527-ios-pwa-route-guard-v269/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260527-ios-pwa-route-guard-v269/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260527-ios-pwa-route-guard-v269/);
