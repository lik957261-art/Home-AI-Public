...
const HERMES_SW_VERSION = "20260522-codex-mux-owner-only-v94";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260522-codex-mux-owner-only-v94",
  "/app-task-artifact-helpers.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-story-helpers.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-reading-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-coins-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-program-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-task-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-reflection-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-api-client.js?v=20260522-codex-mux-owner-only-v94",
  "/app.js?v=20260522-codex-mux-owner-only-v94",
  "/app-codex-mux-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-shell-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-task-groups-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-chat-composer-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-composer-source-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-composer-context-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-run-progress-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-navigation-search-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-sidebar-task-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-message-skill-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-message-actions-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-platform-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-pwa-settings-push-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-workspace-admin-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-access-key-manager-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-share-image-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-draft-thread-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-directory-automation-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-shared-directory-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-automation-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-native-growth-submission-controller.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-ai-controller.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-reward-controller.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-settings-controller.js?v=20260522-codex-mux-owner-only-v94",
  "/app-learning-growth-controller.js?v=20260522-codex-mux-owner-only-v94",
  "/app-automation-controller-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-thread-state-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-group-topic-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-core-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-story-core-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-todo-core-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-render-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-list-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-learning-panel-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-recorder-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-todo-detail-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-actions-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-composer-actions-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-card-actions-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-kanban-study-actions-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-thread-message-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-thread-list-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-thread-directory-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-thread-card-message-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-long-message-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-rich-text-directory-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-message-usage-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-events-composer-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-event-stream-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-upload-sidebar-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-composer-send-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-wire-start-ui.js?v=20260522-codex-mux-owner-only-v94",
  "/app-start.js?v=20260522-codex-mux-owner-only-v94",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260522-codex-mux-owner-only-v94",
  "/file-viewer.html",
