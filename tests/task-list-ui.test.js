...
const CLIENT_VERSION = "20260605-ios-pwa-bottom-nav-v561";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260605-ios-pwa-bottom-nav-v561" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260605-ios-pwa-bottom-nav-v561"><\/noscript>/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260605-ios-pwa-bottom-nav-v561/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260605-ios-pwa-bottom-nav-v561/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260605-ios-pwa-bottom-nav-v561/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260605-ios-pwa-bottom-nav-v561/);
...
assert.match(appJs, /const pluginAppCards = typeof renderPluginAppLauncher === "function"/);
...
assert.match(appJs, /setTopicPluginDock\(pluginAppCards\)/);
