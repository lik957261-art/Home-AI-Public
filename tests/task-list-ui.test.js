...
const CLIENT_VERSION = "20260603-client-refresh-reset-v527";
const appJs = [
...
assert.match(appJs, /showRefreshNotice\(serverVersion, source\);[\s\S]*scheduleClientVersionAutoReset\(serverVersion, source\);/);
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260603-client-refresh-reset-v527" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260603-client-refresh-reset-v527"><\/noscript>/);
...
assert.match(stylesCss, /\.bottom-nav \{[\s\S]*?z-index: 40;[\s\S]*?--bottom-nav-column-min: 48px;[\s\S]*?grid-template-columns: repeat\(5, minmax\(var\(--bottom-nav-column-min\), 1fr\)\);[\s\S]*?padding: 4px env\(safe-area-inset-right\) calc\(3px \+ env\(safe-area-inset-bottom\)\) env\(safe-area-inset-left\);[\s\S]*?overflow-x: auto;/);
...
assert.match(stylesCss, /\.plugin-context-nav-mode \.bottom-tab \{[\s\S]*?gap: 0;[\s\S]*?padding: 0;/);
...
assert.match(stylesCss, /\.plugin-context-nav-mode\.plugin-topic-detail-mode \.composer \{[\s\S]*?margin-bottom: var\(--plugin-context-bottom-nav-height\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260603-client-refresh-reset-v527/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260603-client-refresh-reset-v527/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260603-client-refresh-reset-v527/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260603-client-refresh-reset-v527/);
...
assert.match(stylesCss, /\.plugin-topic-card\.directory-special-plugin \{[\s\S]*?grid-template-rows: minmax\(86px, 1fr\);/);
assert.match(stylesCss, /\.plugin-topic-card\.directory-special-plugin \.plugin-topic-card-main \{[\s\S]*?min-height: 86px;[\s\S]*?grid-template-columns: 78px minmax\(0, 1fr\);/);
...
assert.match(stylesCss, /\.plugin-topic-app-icon\.directory \{[\s\S]*?width: 76px;[\s\S]*?background: transparent url\("\/icons\/file-folder\.svg"\) center \/ contain no-repeat;[\s\S]*?box-shadow: none;/);
...
assert.match(appJs, /const restoreScrollTop = \$\("conversation"\)\?\.scrollTop \|\| 0/);
assert.match(appJs, /data-directory-topic-open-default/);
...
assert.match(appJs, /directory-topic-topic-icon/);
...
assert.match(stylesCss, /\.directory-topic-card-main-row \{[\s\S]*?grid-template-columns: minmax\(0, 1fr\) 34px;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?min-height: 72px;[\s\S]*?background: transparent;[\s\S]*?border: 0;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?touch-action: pan-y;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?grid-template-columns: 34px minmax\(0, 1fr\);/);
...
assert.match(stylesCss, /\.directory-topic-bound-list \{/);
assert.match(stylesCss, /\.directory-topic-chip \{[\s\S]*?min-height: 28px;/);
assert.match(stylesCss, /\.directory-topic-chip \{[\s\S]*?grid-template-columns: 14px minmax\(0, auto\) auto;/);
