...
function createMobileRuntimeEnvironment(options = {}) {
  ...
  const GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS = Math.max(500, Number(env.HERMES_MOBILE_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS || env.HERMES_WEB_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS || "4000") || 4000);
  const GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_STOP_TIMEOUT_MS = Math.max(500, Number(env.HERMES_MOBILE_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_STOP_TIMEOUT_MS || env.HERMES_WEB_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_STOP_TIMEOUT_MS || "1000") || 1000);
