...
function createMobileRuntimeGatewayCompositionOptionsService(options = {}) {
  ...
  function gatewayRuntimeCompositionOptions() {
    ...
    return {
      ...
      nowIso: d.nowIso,
      nowMs: d.nowMs,
      pluginConversationActionBridgeService: s.pluginConversationActionBridgeService || null,
      ...
      restartRunningGatewayWorkers: d.restartRunningGatewayWorkers,
      routeRunToolsets: (...args) => gatewayRunToolsetRoutingService.routePolicy(...args),
      rotateOpenAiCodexCredentialPoolAfterUsageLimit: d.rotateOpenAiCodexCredentialPoolAfterUsageLimit,
