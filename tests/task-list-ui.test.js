...
const CLIENT_VERSION = "20260601-boot-splash-first-paint-v438";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260601-boot-splash-first-paint-v438" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260601-boot-splash-first-paint-v438"><\/noscript>/);
...
assert.match(indexHtml, /id="bottomChatMode"[\s\S]*id="bottomTasksMode"[\s\S]*id="bottomInboxMode"[\s\S]*id="bottomProjectsMode"[\s\S]*id="bottomTodosMode"[\s\S]*id="bottomWardrobeMode"[\s\S]*id="bottomCodexMode"[\s\S]*id="bottomPluginMode"[\s\S]*id="bottomFinanceMode"[\s\S]*id="bottomEmailMode"/);
assert.match(indexHtml, /id="bottomPluginMode"[\s\S]*aria-label="&#24212;&#29992;"[\s\S]*<span class="bottom-tab-label">&#24212;&#29992;<\/span>/);
...
assert.match(appJs, /const hiddenBottomTabs = new Set\(\["bottomPluginMode", "bottomWardrobeMode", "bottomFinanceMode", "bottomEmailMode", "bottomLearningMode", "bottomAutomationMode"\]\)/);
