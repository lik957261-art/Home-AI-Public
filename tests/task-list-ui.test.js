...
const CLIENT_VERSION = "20260602-directory-builtin-plugin-v453";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260602-directory-builtin-plugin-v453" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260602-directory-builtin-plugin-v453"><\/noscript>/);
...
assert.match(indexHtml, /id="bottomChatMode"[\s\S]*id="bottomTasksMode"[\s\S]*id="bottomInboxMode"[\s\S]*id="bottomPluginMode"[\s\S]*id="bottomProjectsMode"[\s\S]*id="bottomTodosMode"[\s\S]*id="bottomWardrobeMode"[\s\S]*id="bottomCodexMode"[\s\S]*id="bottomFinanceMode"[\s\S]*id="bottomEmailMode"/);
...
assert.match(stylesCss, /\.bottom-nav\.codex-visible\.plugins-visible \{[\s\S]*?grid-template-columns: repeat\(7, minmax\(var\(--bottom-nav-column-min\), 1fr\)\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260602-directory-builtin-plugin-v453/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260602-directory-builtin-plugin-v453/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260602-directory-builtin-plugin-v453/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260602-directory-builtin-plugin-v453/);
...
assert.match(appJs, /function renderPluginTopicCards\(\)/);
...
assert.match(stylesCss, /\.plugin-topic-card-main \{[\s\S]*?min-height: 108px;/);
...
assert.match(stylesCss, /\.plugin-topic-action \{[\s\S]*?width: 34px;[\s\S]*?height: 34px;/);
...
assert.match(stylesCss, /\.plugin-topic-action-icon\.folder::after/);
...
assert.match(appJs, /function renderDirectoryTopicCards\(collections = \[\]\)/);
...
assert.match(appJs, /const directoryTopicCollections = typeof directoryTopicCollectionsForGroups === "function"/);
assert.match(appJs, /const directoryTopicGroupIds = typeof directoryTopicCollectionGroupIds === "function"/);
assert.match(appJs, /const regularGroups = groups\.filter\(\(group\) => !group\.pluginTopic && !directoryTopicGroupIds\.has\(group\.id\)\)/);
...
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?min-height: 86px;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?touch-action: pan-y;/);
assert.match(stylesCss, /\.directory-topic-app-icon \{[\s\S]*?width: 50px;[\s\S]*?border-radius: 15px;/);
...
assert.match(clientResetHtml, /if \(!hardResetRequested\(\)\) \{/);
assert.match(clientResetHtml, /await unregisterServiceWorkers\(\)/);
