...
const HERMES_MOBILE_API_ROUTE_SPECS = Object.freeze([
  ...
  exact("owner-workspace-console-summary", "GET", "/api/owner/workspace-console", "workspace-console", routeOptions("workspace-console", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["workspace", "remote-managed-workspace", "status"],
  })),
  exact("remote-managed-workspace-register", "POST", "/api/remote-managed-workspaces/register", "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "node"],
  })),
  regex("remote-managed-workspace-node-heartbeat", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/node-heartbeat$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "heartbeat"],
  })),
  regex("remote-managed-workspace-task-card-poll", "GET", /^\/api\/remote-managed-workspaces\/[^/]+\/task-cards\/poll$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "task-card"],
  })),
  regex("remote-managed-workspace-task-card-ack", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/task-cards\/[^/]+\/ack$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "task-card"],
  })),
  regex("remote-managed-workspace-task-card-heartbeat", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/task-cards\/[^/]+\/heartbeat$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "task-card", "heartbeat"],
  })),
  regex("remote-managed-workspace-task-card-return", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/task-cards\/[^/]+\/return$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "task-card", "return"],
  })),
  regex("remote-managed-workspace-daily-summary", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/daily-summary$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "summary"],
  })),
  regex("remote-managed-workspace-escalation-create", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/escalations$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "high",
    authMode: "internal",
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "escalation"],
  })),
  exact("remote-managed-workspace-status-list", "GET", "/api/remote-managed-workspaces/status", "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["remote-managed-workspace", "status"],
  })),
  regex("remote-managed-workspace-status-read", "GET", /^\/api\/remote-managed-workspaces\/[^/]+\/status$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "owner",
    ownerOnly: true,
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "status"],
  })),
  regex("remote-managed-workspace-task-card-dispatch", "POST", /^\/api\/remote-managed-workspaces\/[^/]+\/task-cards$/, "remote-managed-workspace", routeOptions("remote-managed-workspace", {
    riskLevel: "owner",
    ownerOnly: true,
    workspaceScoped: true,
    resourceTypes: ["remote-managed-workspace", "task-card"],
  })),
  exact("plugin-daily-progress-rollup-status", "GET", "/api/owner/plugin-daily-progress-rollup/status", "plugin-daily-progress-rollup", routeOptions("plugin-daily-progress-rollup", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["plugin-governance", "report", "task-card"],
  })),
  exact("plugin-daily-progress-rollup-trigger", "POST", "/api/owner/plugin-daily-progress-rollup/trigger", "plugin-daily-progress-rollup", routeOptions("plugin-daily-progress-rollup", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["plugin-governance", "task-card", "report"],
  })),
  regex("plugin-daily-progress-rollup-return", "POST", /^\/api\/owner\/plugin-daily-progress-rollup\/runs\/[^/]+\/plugins\/[^/]+\/return$/, "plugin-daily-progress-rollup", routeOptions("plugin-daily-progress-rollup", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["plugin-governance", "task-card", "return-card", "report"],
  })),
  regex("plugin-daily-progress-rollup-finalize", "POST", /^\/api\/owner\/plugin-daily-progress-rollup\/runs\/[^/]+\/finalize$/, "plugin-daily-progress-rollup", routeOptions("plugin-daily-progress-rollup", {
    riskLevel: "owner",
    ownerOnly: true,
  ...
  exact("ai-ops-diagnostics-events-create", "POST", "/api/v1/home-ai/diagnostics/events", "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "medium",
    workspaceScoped: true,
    resourceTypes: ["diagnostic-event", "diagnostic-case"],
    summary: "Submit a bounded Home AI diagnostic event.",
  })),
  exact("ai-ops-diagnostics-cases-list", "GET", "/api/v1/home-ai/diagnostics/cases", "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["diagnostic-case"],
    summary: "List AI Ops diagnostic cases.",
  })),
  regex("ai-ops-diagnostics-case-read", "GET", /^\/api\/v1\/home-ai\/diagnostics\/cases\/[^/]+$/, "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["diagnostic-case"],
    summary: "Read a bounded AI Ops diagnostic case.",
  })),
  exact("ai-ops-diagnostics-events-list", "GET", "/api/v1/home-ai/diagnostics/events", "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["diagnostic-event"],
    summary: "List bounded diagnostic events for a case.",
  })),
  regex("ai-ops-diagnostics-case-state", "POST", /^\/api\/v1\/home-ai\/diagnostics\/cases\/[^/]+\/state$/, "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["diagnostic-case", "case-state"],
    summary: "Update a diagnostic case lifecycle state.",
  })),
  regex("ai-ops-diagnostics-case-task-card", "POST", /^\/api\/v1\/home-ai\/diagnostics\/cases\/[^/]+\/task-card$/, "ai-ops-diagnostics", routeOptions("ai-ops-diagnostics", {
    riskLevel: "owner",
    ownerOnly: true,
  ...
  exact("plugin-conversation-action-create", "POST", "/api/plugin-conversation/actions", "plugin-conversation-actions", routeOptions("plugin-conversation-actions", {
    riskLevel: "medium",
    workspaceScoped: true,
  ...
  exact("autonomous-delivery-case-list", "GET", "/api/autonomous-delivery/cases", "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "low",
    workspaceScoped: true,
    resourceTypes: ["autonomous-delivery", "action-inbox"],
    summary: "List workspace-scoped autonomous delivery cases.",
  })),
  exact("autonomous-delivery-case-create", "POST", "/api/autonomous-delivery/cases", "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "medium",
    workspaceScoped: true,
    resourceTypes: ["autonomous-delivery", "action-inbox"],
    summary: "Create an Owner-gated autonomous delivery case and Action Inbox decision item.",
  })),
  regex("autonomous-delivery-case-detail", "GET", /^\/api\/autonomous-delivery\/cases\/[^/]+$/, "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "low",
    workspaceScoped: true,
    resourceTypes: ["autonomous-delivery"],
    summary: "Read one autonomous delivery case with slices and events.",
  })),
  regex("autonomous-delivery-case-start", "POST", /^\/api\/autonomous-delivery\/cases\/[^/]+\/start$/, "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "owner",
    ownerOnly: true,
  ...
  regex("autonomous-delivery-slice-return", "POST", /^\/api\/autonomous-delivery\/cases\/[^/]+\/slices\/[^/]+\/return$/, "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["autonomous-delivery", "codex-task-card"],
    summary: "Record a terminal return-card state for an autonomous delivery slice.",
  })),
  regex("autonomous-delivery-task-card-return", "POST", /^\/api\/autonomous-delivery\/task-cards\/[^/]+\/return$/, "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["autonomous-delivery", "codex-task-card"],
    summary: "Record a terminal return-card state by original dispatched task-card id.",
  })),
  exact("autonomous-delivery-return-card-event", "POST", "/api/autonomous-delivery/return-card-events", "autonomous-delivery", routeOptions("autonomous-delivery", {
    riskLevel: "owner",
    ownerOnly: true,
    resourceTypes: ["autonomous-delivery", "codex-task-card"],
    summary: "Ingest a bounded terminal return-card event from the task-card transport.",
  })),
  exact("home-ai-tts-synthesize", "POST", "/api/v1/home-ai/tts/synthesize", "home-ai-tts", routeOptions("home-ai-tts", {
    riskLevel: "medium",
    workspaceScoped: true,
    resourceTypes: ["tts-asset", "audio"],
    summary: "Synthesize and persist a Home AI local TTS asset.",
  })),
  exact("home-ai-tts-assets-list", "GET", "/api/v1/home-ai/tts/assets", "home-ai-tts", routeOptions("home-ai-tts", {
    workspaceScoped: true,
    resourceTypes: ["tts-asset"],
    summary: "List Home AI TTS assets by plugin or demo metadata.",
  })),
  regex("home-ai-tts-asset-read", "GET", /^\/api\/v1\/home-ai\/tts\/assets\/[^/]+$/, "home-ai-tts", routeOptions("home-ai-tts", {
    workspaceScoped: true,
    resourceTypes: ["tts-asset"],
    summary: "Read Home AI TTS asset metadata.",
  })),
  regex("home-ai-tts-asset-file", "GET", /^\/api\/v1\/home-ai\/tts\/assets\/[^/]+\/file$/, "home-ai-tts", routeOptions("home-ai-tts", {
    workspaceScoped: true,
    resourceTypes: ["tts-asset", "audio"],
    summary: "Stream a persisted Home AI TTS audio file.",
  })),
  regex("home-ai-tts-asset-delete", "POST", /^\/api\/v1\/home-ai\/tts\/assets\/[^/]+\/delete$/, "home-ai-tts", routeOptions("home-ai-tts", {
    riskLevel: "medium",
    workspaceScoped: true,
    resourceTypes: ["tts-asset", "audio"],
    summary: "Delete a persisted Home AI TTS asset and watched-folder copy.",
  })),
  exact("home-ai-tts-demo-plan-narrations", "POST", "/api/v1/home-ai/tts/demo-plans/narrations", "home-ai-tts", routeOptions("home-ai-tts", {
    riskLevel: "medium",
    workspaceScoped: true,
    resourceTypes: ["tts-asset", "music-demo"],
    summary: "Batch synthesize Music demo-plan narration assets.",
  })),
  ...
  exact("learning-task-series-recommendation-draft-create", "POST", "/api/learning/recommendations/task-series/draft", "learning-program", routeOptions("learning-program", {
    riskLevel: "owner",
    ownerOnly: true,
    workspaceScoped: true,
