...
try {
  ...
  assert.equal(
    updated.workers[0].telemetryStateDbPath,
    "/Users/hm-owner/HermesWorkspace/.hermes-gateway/profiles/hm-owner-openai-1/state.db",
  );
  assert.equal(
    updated.workers[1].telemetryResponseStoreDbPath,
    "/Users/hm-wuping/HermesWorkspace/.hermes-gateway/profiles/hm-wuping-openai-1/response_store.db",
  );
