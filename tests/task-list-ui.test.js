...
const CLIENT_VERSION = "20260528-wardrobe-plugin-only-v339";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260528-wardrobe-plugin-only-v339/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260528-wardrobe-plugin-only-v339/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260528-wardrobe-plugin-only-v339/);
