...
const CLIENT_VERSION = "20260607-directory-route-context-v591";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260607-directory-route-context-v591" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260607-directory-route-context-v591"><\/noscript>/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260607-directory-route-context-v591/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260607-directory-route-context-v591/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260607-directory-route-context-v591/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260607-directory-route-context-v591/);
...
assert.match(appJs, /function recordPluginTopicUsage\(pluginId\)/);
...
assert.match(appJs, /const CAPABILITY_QUICK_ACTION_LIMIT = 8;/);
...
assert.match(appJs, /class="capability-quick-grid" data-capability-quick-rows="4"/);
assert.match(appJs, /class="capability-action-source"/);
...
assert.match(stylesCss, /\.capability-quick-grid \{[\s\S]*?grid-template-columns: repeat\(2, minmax\(0, 1fr\)\)/);
assert.match(stylesCss, /\.capability-quick-action \{[\s\S]*?grid-template-columns: 28px minmax\(0, 1fr\) 22px;/);
assert.match(stylesCss, /\.capability-action-source \{[\s\S]*?font-size: 10px;/);
...
assert.match(stylesCss, /\.task-list-mode \.plugin-app-card \.plugin-topic-app-icon\.directory \{[\s\S]*?width: 48px;[\s\S]*?height: 48px;[\s\S]*?--directory-folder-tab-top: 11px;[\s\S]*?--directory-folder-body-top: 17px;[\s\S]*?--directory-folder-body-width: 40px;[\s\S]*?--directory-folder-body-height: 24px;[\s\S]*?border-radius: 14px;/);
...
assert.match(appJs, /\\u76ee\\u5f55\\u7ed1\\u5b9a\\u8bdd\\u9898/);
...
assert.match(appJs, /directory-topic-chip-badge/);
...
assert.match(stylesCss, /\.directory-topic-association-label \{[\s\S]*?font-weight: 650;/);
assert.match(stylesCss, /\.directory-topic-association-icon::after/);
...
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?min-height: 56px;[\s\S]*?background: transparent;[\s\S]*?border: 0;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?touch-action: pan-y;/);
assert.match(stylesCss, /\.directory-topic-card-main \{[\s\S]*?grid-template-columns: 16px 30px minmax\(0, 1fr\);/);
assert.match(stylesCss, /@media \(max-width: 760px\) \{[\s\S]*?\.directory-topic-card-main \{[\s\S]*?grid-template-columns: 16px 30px minmax\(0, 1fr\);/);
...
assert.match(stylesCss, /\.directory-topic-folder-icon \{[\s\S]*?width: 26px;[\s\S]*?height: 26px;/);
...
assert.match(stylesCss, /\.directory-topic-bound-list \{[\s\S]*?display: grid;[\s\S]*?margin-left: 48px;[\s\S]*?border-left: 1px solid/);
...
assert.match(stylesCss, /\.directory-topic-chip \{[\s\S]*?grid-template-columns: 14px minmax\(0, 1fr\) auto;/);
