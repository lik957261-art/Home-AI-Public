...
const BASELINE_DIAGNOSTICS = [
  ...
  },
  {
    ...
    title: "Home AI self-improving loop signal matrix, observation collector, and audit request gate",
    script: "scripts/homeai-self-improving-loop.js",
    sourceHarness: "tests/home-ai-self-improving-loop-service.test.js",
    command: [
      "<node>",
      "<app>/scripts/homeai-self-improving-loop.js",
      "--matrix",
      "--json",
    ],
  ...
  {
    id: "gateway-document-file-tools-schema",
    title: "Mac Gateway document file tools callable schema smoke",
    script: "scripts/gateway-tool-schema-smoke.js",
    sourceHarness: "tests/startup-scripts.test.js",
    command: [
      "sudo",
      "<node>",
      "<app>/scripts/gateway-tool-schema-smoke.js",
      "--manifest",
      "<mac-root>/data/gateway-pool-manifest-mac.json",
      "--profile",
      "hm-owner-openai-1",
      "--profile-plugin-schema-only",
      "--profile-plugin-filter",
      "hermes-mobile-docx,hermes-mobile-pptx,hermes-mobile-pdf,hermes-mobile-audio,hermes-mobile-archive",
      "--runtime-python",
  ...
  {
    id: "automation-cron-launchd",
    title: "Mac Automation launchd scheduled-path smoke",
    script: "scripts/macos-automation-cron-launchd-smoke.js",
    sourceHarness: "tests/macos-automation-cron-launchd-smoke.test.js",
    command: [
      "sudo",
      "<node>",
      "<app>/scripts/macos-automation-cron-launchd-smoke.js",
      "--root",
      "<mac-root>",
      "--json",
    ],
    requiredFor: ["Automation", "scheduled jobs", "launchd scheduled path", "backup jobs"],
  },
  {
