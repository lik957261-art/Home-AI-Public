...
function createMobileRuntimeCoreProviders(deps = {}) {
  ...
  const authProvider = createAuthProvider({
    ...
    auditOwnerReadonlyKey: () => env.HERMES_MOBILE_AUDIT_OWNER_READONLY_KEY || env.HERMES_WEB_AUDIT_OWNER_READONLY_KEY || "",
    auditOwnerReadonlyKeyPath: () => runtimeEnv.AUDIT_OWNER_READONLY_KEY_PATH,
  ...
  const securityBoundaryProvider = createSecurityBoundaryProvider({
    ...
    protectedRoots: () => deps.dedupe([
      ...
      runtimeEnv.AUDIT_OWNER_READONLY_KEY_PATH ? deps.path.dirname(runtimeEnv.AUDIT_OWNER_READONLY_KEY_PATH) : "",
    ...
    protectedFiles: () => deps.dedupe([
      ...
      runtimeEnv.AUDIT_OWNER_READONLY_KEY_PATH,
