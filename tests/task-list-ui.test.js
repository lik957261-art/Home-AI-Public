...
const CLIENT_VERSION = "20260602-directory-topic-first-frame-v468";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260602-directory-topic-first-frame-v468" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260602-directory-topic-first-frame-v468"><\/noscript>/);
...
assert.match(indexHtml, /id="bottomChatMode"[\s\S]*id="bottomInboxMode"[\s\S]*id="bottomTasksMode"[\s\S]*id="bottomPluginMode"[\s\S]*id="bottomProjectsMode"[\s\S]*id="bottomTodosMode"[\s\S]*id="bottomWardrobeMode"[\s\S]*id="bottomCodexMode"[\s\S]*id="bottomFinanceMode"[\s\S]*id="bottomEmailMode"/);
assert.match(indexHtml, /id="bottomPluginMode"[\s\S]*aria-label="&#25554;&#20214;"[\s\S]*<span class="bottom-tab-label">&#25554;&#20214;<\/span>/);
assert.match(indexHtml, /id="bottomPluginMenu"[\s\S]*id="bottomPluginWardrobeMode"[\s\S]*id="bottomPluginFinanceMode"[\s\S]*id="bottomPluginEmailMode"/);
...
assert.match(indexHtml, /id="bottomPluginMode"[\s\S]*hidden aria-hidden="true"/);
...
assert.match(appJs, /const hiddenBottomTabs = new Set\(\["bottomPluginMode", "bottomProjectsMode", "bottomWardrobeMode", "bottomFinanceMode", "bottomEmailMode", "bottomLearningMode", "bottomAutomationMode"\]\)/);
assert.match(appJs, /function updateBottomPluginMenuAvailability\(\) \{\s+const available = false;/);
...
assert.match(stylesCss, /\.bottom-nav \{[\s\S]*?z-index: 40;[\s\S]*?--bottom-nav-column-min: 48px;[\s\S]*?grid-template-columns: repeat\(5, minmax\(var\(--bottom-nav-column-min\), 1fr\)\);[\s\S]*?overflow-x: auto;/);
...
assert.match(stylesCss, /\.bottom-nav\.codex-visible\.plugins-visible \{[\s\S]*?grid-template-columns: repeat\(6, minmax\(var\(--bottom-nav-column-min\), 1fr\)\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260602-directory-topic-first-frame-v468/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260602-directory-topic-first-frame-v468/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260602-directory-topic-first-frame-v468/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260602-directory-topic-first-frame-v468/);
...
assert.match(appJs, /\$\("bottomPluginMode"\)\?\.addEventListener\("click"/);
assert.match(appJs, /\$\("bottomPluginWardrobeMode"\)\?\.addEventListener\("click"/);
