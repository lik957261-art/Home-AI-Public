...
const CLIENT_VERSION = "20260531-dark-preview-contrast-v382";
const appJs = [
...
assert.match(indexHtml, /<style id="hermesInitialThemeStyle">[\s\S]*?html\[data-effective-theme="dark"\] \{[\s\S]*?background: #0e1113;[\s\S]*?color-scheme: dark;/);
...
assert.match(stylesCss, /:root\[data-theme="dark"\] \{[\s\S]*?color-scheme: dark;[\s\S]*?--ui-page: #0e1113;[\s\S]*?--ui-field-bg: rgba\(255, 255, 255, 0\.15\);[\s\S]*?--ui-card-surface: rgba\(38, 48, 53, 0\.94\);/);
assert.match(stylesCss, /@media \(prefers-color-scheme: dark\) \{[\s\S]*?:root\[data-theme="system"\]/);
assert.match(stylesCss, /:root\[data-theme="dark"\] \.run-progress-panel \{[\s\S]*?background: rgba\(30, 36, 39, 0\.92\);[\s\S]*?border-color: rgba\(222, 232, 232, 0\.12\);/);
assert.match(stylesCss, /:root\[data-theme="dark"\] \.run-progress-preview \{[\s\S]*?color: #bdc8ca;/);
...
assert.match(markdownViewerHtml, /html\[data-effective-theme="dark"\] \{[\s\S]*?--paper: #0e1113;[\s\S]*?--ink: #f3f6f5;/);
...
assert.match(fileViewerHtml, /html\[data-effective-theme="dark"\] \{[\s\S]*?--paper: #0e1113;[\s\S]*?--panel: rgba\(34, 42, 47, 0\.96\);/);
...
assert.match(pdfViewerHtml, /html\[data-effective-theme="dark"\] \{[\s\S]*?--pdf-page-bg: #0e1113;[\s\S]*?--pdf-canvas-bg: #171d21;/);
