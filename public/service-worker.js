...
const HERMES_SW_VERSION = "20260518-weixin-file-only-v18";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260518-weixin-file-only-v18",
  "/app-task-artifact-helpers.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-story-helpers.js?v=20260518-weixin-file-only-v18",
  "/app-learning-reading-ui.js?v=20260518-weixin-file-only-v18",
  "/app-learning-coins-ui.js?v=20260518-weixin-file-only-v18",
  "/app-learning-program-ui.js?v=20260518-weixin-file-only-v18",
  "/app-learning-growth-ui.js?v=20260518-weixin-file-only-v18",
  "/app-learning-growth-task-ui.js?v=20260518-weixin-file-only-v18",
  "/app-api-client.js?v=20260518-weixin-file-only-v18",
  "/app.js?v=20260518-weixin-file-only-v18",
  "/app-shell-ui.js?v=20260518-weixin-file-only-v18",
  "/app-task-groups-ui.js?v=20260518-weixin-file-only-v18",
  "/app-chat-composer-ui.js?v=20260518-weixin-file-only-v18",
  "/app-composer-context-ui.js?v=20260518-weixin-file-only-v18",
  "/app-run-progress-ui.js?v=20260518-weixin-file-only-v18",
  "/app-navigation-search-ui.js?v=20260518-weixin-file-only-v18",
  "/app-sidebar-task-ui.js?v=20260518-weixin-file-only-v18",
  "/app-message-actions-ui.js?v=20260518-weixin-file-only-v18",
  "/app-platform-ui.js?v=20260518-weixin-file-only-v18",
  "/app-pwa-settings-push-ui.js?v=20260518-weixin-file-only-v18",
  "/app-workspace-admin-ui.js?v=20260518-weixin-file-only-v18",
  "/app-access-key-manager-ui.js?v=20260518-weixin-file-only-v18",
  "/app-share-image-ui.js?v=20260518-weixin-file-only-v18",
  "/app-draft-thread-ui.js?v=20260518-weixin-file-only-v18",
  "/app-directory-automation-ui.js?v=20260518-weixin-file-only-v18",
  "/app-shared-directory-ui.js?v=20260518-weixin-file-only-v18",
  "/app-automation-ui.js?v=20260518-weixin-file-only-v18",
  "/app-learning-growth-controller.js?v=20260518-weixin-file-only-v18",
  "/app-automation-controller-ui.js?v=20260518-weixin-file-only-v18",
  "/app-thread-state-ui.js?v=20260518-weixin-file-only-v18",
  "/app-group-topic-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-core-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-story-core-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-todo-core-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-render-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-list-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-learning-panel-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-recorder-ui.js?v=20260518-weixin-file-only-v18",
  "/app-todo-detail-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-actions-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-composer-actions-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-card-actions-ui.js?v=20260518-weixin-file-only-v18",
  "/app-kanban-study-actions-ui.js?v=20260518-weixin-file-only-v18",
  "/app-thread-message-ui.js?v=20260518-weixin-file-only-v18",
  "/app-thread-list-ui.js?v=20260518-weixin-file-only-v18",
  "/app-thread-directory-ui.js?v=20260518-weixin-file-only-v18",
  "/app-thread-card-message-ui.js?v=20260518-weixin-file-only-v18",
  "/app-rich-text-directory-ui.js?v=20260518-weixin-file-only-v18",
  "/app-message-usage-ui.js?v=20260518-weixin-file-only-v18",
  "/app-events-composer-ui.js?v=20260518-weixin-file-only-v18",
  "/app-event-stream-ui.js?v=20260518-weixin-file-only-v18",
  "/app-upload-sidebar-ui.js?v=20260518-weixin-file-only-v18",
  "/app-composer-send-ui.js?v=20260518-weixin-file-only-v18",
  "/app-wire-start-ui.js?v=20260518-weixin-file-only-v18",
  "/app-start.js?v=20260518-weixin-file-only-v18",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260518-weixin-file-only-v18",
  "/file-viewer.html",
