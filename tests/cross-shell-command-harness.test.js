...
assert.match(startGatewayPool, /Start-LowGateways -Profiles \$resolvedStartProfiles -Replicas \$resolvedStartReplicas -NoStopExisting:\$NoStopExisting -ForceConfigure:\$ForceConfigure/);
