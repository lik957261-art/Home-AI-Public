...
const CLIENT_VERSION = "20260526-automation-delete-refresh-v262";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260526-automation-delete-refresh-v262/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260526-automation-delete-refresh-v262/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260526-automation-delete-refresh-v262/);
