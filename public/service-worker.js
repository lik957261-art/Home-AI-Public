...
const HERMES_SW_VERSION = "20260517-md-weixin-forward";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-md-weixin-forward",
  "/app-task-artifact-helpers.js?v=20260517-md-weixin-forward",
  "/app-kanban-story-helpers.js?v=20260517-md-weixin-forward",
  "/app-learning-reading-ui.js?v=20260517-md-weixin-forward",
  "/app-learning-coins-ui.js?v=20260517-md-weixin-forward",
  "/app-learning-program-ui.js?v=20260517-md-weixin-forward",
  "/app-learning-growth-ui.js?v=20260517-md-weixin-forward",
  "/app-api-client.js?v=20260517-md-weixin-forward",
  "/app.js?v=20260517-md-weixin-forward",
  "/app-shell-ui.js?v=20260517-md-weixin-forward",
  "/app-task-groups-ui.js?v=20260517-md-weixin-forward",
  "/app-chat-composer-ui.js?v=20260517-md-weixin-forward",
  "/app-composer-context-ui.js?v=20260517-md-weixin-forward",
  "/app-run-progress-ui.js?v=20260517-md-weixin-forward",
  "/app-navigation-search-ui.js?v=20260517-md-weixin-forward",
  "/app-sidebar-task-ui.js?v=20260517-md-weixin-forward",
  "/app-message-actions-ui.js?v=20260517-md-weixin-forward",
  "/app-platform-ui.js?v=20260517-md-weixin-forward",
  "/app-pwa-settings-push-ui.js?v=20260517-md-weixin-forward",
  "/app-workspace-admin-ui.js?v=20260517-md-weixin-forward",
  "/app-access-key-manager-ui.js?v=20260517-md-weixin-forward",
  "/app-share-image-ui.js?v=20260517-md-weixin-forward",
  "/app-draft-thread-ui.js?v=20260517-md-weixin-forward",
  "/app-directory-automation-ui.js?v=20260517-md-weixin-forward",
  "/app-shared-directory-ui.js?v=20260517-md-weixin-forward",
  "/app-automation-ui.js?v=20260517-md-weixin-forward",
  "/app-learning-growth-controller.js?v=20260517-md-weixin-forward",
  "/app-automation-controller-ui.js?v=20260517-md-weixin-forward",
  "/app-thread-state-ui.js?v=20260517-md-weixin-forward",
  "/app-group-topic-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-core-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-story-core-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-todo-core-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-render-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-list-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-learning-panel-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-recorder-ui.js?v=20260517-md-weixin-forward",
  "/app-todo-detail-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-actions-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-composer-actions-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-card-actions-ui.js?v=20260517-md-weixin-forward",
  "/app-kanban-study-actions-ui.js?v=20260517-md-weixin-forward",
  "/app-thread-message-ui.js?v=20260517-md-weixin-forward",
  "/app-thread-list-ui.js?v=20260517-md-weixin-forward",
  "/app-thread-directory-ui.js?v=20260517-md-weixin-forward",
  "/app-thread-card-message-ui.js?v=20260517-md-weixin-forward",
  "/app-rich-text-directory-ui.js?v=20260517-md-weixin-forward",
  "/app-message-usage-ui.js?v=20260517-md-weixin-forward",
  "/app-events-composer-ui.js?v=20260517-md-weixin-forward",
  "/app-event-stream-ui.js?v=20260517-md-weixin-forward",
  "/app-upload-sidebar-ui.js?v=20260517-md-weixin-forward",
  "/app-composer-send-ui.js?v=20260517-md-weixin-forward",
  "/app-wire-start-ui.js?v=20260517-md-weixin-forward",
  "/app-start.js?v=20260517-md-weixin-forward",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-md-weixin-forward",
  "/file-viewer.html",
