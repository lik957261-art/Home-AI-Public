...
const HERMES_SW_VERSION = "20260517-growth-kanban-submit";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-growth-kanban-submit",
  "/app-task-artifact-helpers.js?v=20260517-growth-kanban-submit",
  "/app-kanban-story-helpers.js?v=20260517-growth-kanban-submit",
  "/app-learning-reading-ui.js?v=20260517-growth-kanban-submit",
  "/app-learning-coins-ui.js?v=20260517-growth-kanban-submit",
  "/app-learning-program-ui.js?v=20260517-growth-kanban-submit",
  "/app-learning-growth-ui.js?v=20260517-growth-kanban-submit",
  "/app-api-client.js?v=20260517-growth-kanban-submit",
  "/app.js?v=20260517-growth-kanban-submit",
  "/app-shell-ui.js?v=20260517-growth-kanban-submit",
  "/app-task-groups-ui.js?v=20260517-growth-kanban-submit",
  "/app-chat-composer-ui.js?v=20260517-growth-kanban-submit",
  "/app-composer-context-ui.js?v=20260517-growth-kanban-submit",
  "/app-run-progress-ui.js?v=20260517-growth-kanban-submit",
  "/app-navigation-search-ui.js?v=20260517-growth-kanban-submit",
  "/app-sidebar-task-ui.js?v=20260517-growth-kanban-submit",
  "/app-message-actions-ui.js?v=20260517-growth-kanban-submit",
  "/app-platform-ui.js?v=20260517-growth-kanban-submit",
  "/app-pwa-settings-push-ui.js?v=20260517-growth-kanban-submit",
  "/app-workspace-admin-ui.js?v=20260517-growth-kanban-submit",
  "/app-access-key-manager-ui.js?v=20260517-growth-kanban-submit",
  "/app-share-image-ui.js?v=20260517-growth-kanban-submit",
  "/app-draft-thread-ui.js?v=20260517-growth-kanban-submit",
  "/app-directory-automation-ui.js?v=20260517-growth-kanban-submit",
  "/app-shared-directory-ui.js?v=20260517-growth-kanban-submit",
  "/app-automation-ui.js?v=20260517-growth-kanban-submit",
  "/app-learning-growth-controller.js?v=20260517-growth-kanban-submit",
  "/app-automation-controller-ui.js?v=20260517-growth-kanban-submit",
  "/app-thread-state-ui.js?v=20260517-growth-kanban-submit",
  "/app-group-topic-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-core-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-story-core-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-todo-core-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-render-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-list-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-learning-panel-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-recorder-ui.js?v=20260517-growth-kanban-submit",
  "/app-todo-detail-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-actions-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-composer-actions-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-card-actions-ui.js?v=20260517-growth-kanban-submit",
  "/app-kanban-study-actions-ui.js?v=20260517-growth-kanban-submit",
  "/app-thread-message-ui.js?v=20260517-growth-kanban-submit",
  "/app-thread-list-ui.js?v=20260517-growth-kanban-submit",
  "/app-thread-directory-ui.js?v=20260517-growth-kanban-submit",
  "/app-thread-card-message-ui.js?v=20260517-growth-kanban-submit",
  "/app-rich-text-directory-ui.js?v=20260517-growth-kanban-submit",
  "/app-message-usage-ui.js?v=20260517-growth-kanban-submit",
  "/app-events-composer-ui.js?v=20260517-growth-kanban-submit",
  "/app-event-stream-ui.js?v=20260517-growth-kanban-submit",
  "/app-upload-sidebar-ui.js?v=20260517-growth-kanban-submit",
  "/app-composer-send-ui.js?v=20260517-growth-kanban-submit",
  "/app-wire-start-ui.js?v=20260517-growth-kanban-submit",
  "/app-start.js?v=20260517-growth-kanban-submit",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-growth-kanban-submit",
  "/file-viewer.html",
