...
const CLIENT_VERSION = "20260612-codex-bottom-pin-v716";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260612-codex-bottom-pin-v716" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260612-codex-bottom-pin-v716"><\/noscript>/);
...
assert.match(appJs, /bottomTasksMode"\)\?\.addEventListener\("click"[\s\S]*?const pluginContextDef = typeof pluginTopicDefForViewMode === "function"[\s\S]*?if \(pluginContextDef\) \{[\s\S]*?openPluginTopicChat\(pluginContextDef\.id, \{ deferViewModeApplyUntilLoaded: true \}\);[\s\S]*?return;/);
...
assert.match(appJs, /document\.querySelectorAll\("\.bottom-tab"\)\.forEach\(\(node\) => \{[\s\S]*?setBottomTabHidden\(node, !visible\);/);
...
assert.match(stylesCss, /\.plugin-context-nav-mode #bottomTasksMode \{[\s\S]*?order: 1 !important;/);
assert.match(stylesCss, /\.plugin-context-nav-mode #bottomProjectsMode \{[\s\S]*?order: 3 !important;/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260612-codex-bottom-pin-v716/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260612-codex-bottom-pin-v716/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260612-codex-bottom-pin-v716/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260612-codex-bottom-pin-v716/);
