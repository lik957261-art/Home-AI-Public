...
meaningful content line after Markdown/meta stripping; low-information opener
lines such as short `my judgment is:` prefaces are skipped. Model runs also
receive a built-in Home AI host instruction, not a Skill, that asks every final
assistant reply to append a hidden Markdown HTML comment:
