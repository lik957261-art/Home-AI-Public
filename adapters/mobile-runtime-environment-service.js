...
function createMobileRuntimeEnvironment(options = {}) {
  ...
  const GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_ENABLED = !/^(0|false|no|off)$/i.test(env.HERMES_MOBILE_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION || env.HERMES_WEB_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION || "1");
  const GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS = Math.max(1000, Number(env.HERMES_MOBILE_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS || env.HERMES_WEB_GATEWAY_MODEL_FIRST_TOOLSET_SELECTION_TIMEOUT_MS || "15000") || 15000);
