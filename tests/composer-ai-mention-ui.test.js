...
assert.match(appJs, /return \[chatGptProMentionOption\(\), chatGptXhigh, \.\.\.grokOptions\]\.slice\(0, 3\)/);
...
assert.match(appJs, /return gatewayName \? \{ label: `Gateway \$\{gatewayName\}`, tone: "active" \} : null/);
