...
const MOBILE_API_AUTHENTICATED_ROUTE_PIPELINE = Object.freeze([
  ...
  Object.freeze({ key: "autonomousDeliveryApiRoutes", passAuth: true }),
  Object.freeze({ key: "aiOpsDiagnosticApiRoutes", passAuth: true }),
  Object.freeze({ key: "pluginConversationActionApiRoutes", passAuth: true }),
  Object.freeze({ key: "dataContextApiRoutes", passAuth: true }),
  Object.freeze({ key: "homeAiTtsApiRoutes", passAuth: true }),
