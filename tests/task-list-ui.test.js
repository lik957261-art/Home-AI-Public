...
const CLIENT_VERSION = "20260609-plugin-context-viewport-v644";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260609-plugin-context-viewport-v644" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260609-plugin-context-viewport-v644"><\/noscript>/);
...
assert.match(stylesCss, /\.plugin-context-nav-mode\.wardrobe-plugin-host-active \.main,[\s\S]*?\.plugin-context-nav-mode\.embedded-plugin-host-active \.main \{[\s\S]*?position: absolute;[\s\S]*?top: 0;[\s\S]*?right: 0;[\s\S]*?bottom: var\(--plugin-context-main-bottom, var\(--plugin-context-bottom-nav-height\)\);[\s\S]*?left: 0;[\s\S]*?min-height: 0;/);
...
assert.match(appJs, /const bottomInset = Math\.max\(navHeight, navHeight \+ viewportOverflow\)/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260609-plugin-context-viewport-v644/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260609-plugin-context-viewport-v644/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260609-plugin-context-viewport-v644/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260609-plugin-context-viewport-v644/);
