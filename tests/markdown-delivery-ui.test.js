...
assert.doesNotMatch(fileViewer, /data-markdown-share="weixin"/);
...
assert.match(fileViewer, /\/uploads`/);
assert.match(fileViewer, /dataBase64/);
assert.match(fileViewer, /artifacts: \[upload\.artifact\]/);
...
assert.match(markdownViewer, /fontScale: "normal"/);
