...
assert.match(startGatewayPool, /powershell\.exe -NoProfile -ExecutionPolicy Bypass -File \$stopChild/);
assert.match(startGatewayPool, /powershell\.exe -NoProfile -ExecutionPolicy Bypass -File \$child -DistroName \$LowGatewayDistroName/);
