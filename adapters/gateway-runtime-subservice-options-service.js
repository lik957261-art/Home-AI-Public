...
function createGatewayRuntimeSubserviceOptionsService(deps = {}) {
  ...
  function eventServiceOptions(controllers = {}) {
    return {
      ...
      pluginConversationActionBridgeService: deps.pluginConversationActionBridgeService || null,
      restartRunningGatewayWorkers: deps.restartRunningGatewayWorkers,
      removeThreadActiveRun: controllers.removeThreadActiveRun,
      replaceThreadActiveRun: controllers.replaceThreadActiveRun,
      rotateOpenAiCodexCredentialPoolAfterUsageLimit: deps.rotateOpenAiCodexCredentialPoolAfterUsageLimit,
      saveState: deps.saveState,
      scheduleNextQueuedRunForTaskGroup: controllers.scheduleNextQueuedRunForTaskGroup,
      startQuotaFailoverRun: controllers.startRunForThread,
