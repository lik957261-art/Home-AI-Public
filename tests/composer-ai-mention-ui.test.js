...
assert.match(stylesCss, /@media \(max-width: 1099px\)[\s\S]*?\.composer\s*\{[^}]*grid-template-columns:\s*36px minmax\(0, 1fr\) 48px;[\s\S]*?padding:\s*5px max\(10px, env\(safe-area-inset-right\)\) 5px max\(8px, env\(safe-area-inset-left\)\);/);
