...
assert.match(source, /Start-Process -FilePath \$NativePython/, "launcher should start native Python directly");
assert.match(source, /-WindowStyle Hidden/, "launcher should avoid visible command windows");
