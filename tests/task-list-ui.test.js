...
assert.match(mobileRuntimeGatewayProviderServiceJs, /gatewayPoolStatusHealthy: defaultGatewayPoolStatusHealthy/);
assert.match(mobileRuntimeGatewayProviderServiceJs, /status\.fallbackError = status\.error \|\| ""/);
