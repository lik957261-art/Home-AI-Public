...
const HERMES_SW_VERSION = "20260530-plugin-proxy-refresh-v359";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260530-plugin-proxy-refresh-v359",
  "/markdown-viewer.html?v=20260530-plugin-proxy-refresh-v359",
  "/app-task-artifact-helpers.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-story-helpers.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-reading-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-coins-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-program-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-task-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-reflection-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-api-client.js?v=20260530-plugin-proxy-refresh-v359",
  "/app.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-shell-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-task-groups-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-navigation-view-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-chat-composer-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-composer-source-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-composer-context-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-run-progress-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-navigation-search-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-task-preview-helpers-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-task-preview-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-sidebar-task-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-message-skill-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-message-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-platform-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-platform-status-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-pwa-settings-push-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-pwa-push-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-workspace-admin-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-access-key-manager-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-share-image-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-draft-thread-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-directory-automation-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-shared-directory-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-embedded-plugin-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-wardrobe-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-action-inbox-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-automation-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-native-growth-submission-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-ai-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-reward-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-settings-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-teaching-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-learning-growth-controller.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-automation-controller-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-automation-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-thread-state-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-group-topic-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-core-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-story-core-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-todo-core-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-render-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-list-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-learning-panel-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-recorder-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-todo-detail-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-composer-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-card-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-kanban-study-actions-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-thread-message-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-thread-list-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-thread-directory-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-thread-card-message-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-long-message-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-rich-text-directory-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-message-usage-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-events-composer-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-event-stream-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-upload-sidebar-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-composer-send-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-wire-start-ui.js?v=20260530-plugin-proxy-refresh-v359",
  "/app-start.js?v=20260530-plugin-proxy-refresh-v359",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260530-plugin-proxy-refresh-v359",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
