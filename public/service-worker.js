...
const HERMES_SW_VERSION = "20260610-plugin-topic-root-level-v697";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260610-plugin-topic-root-level-v697",
  "/markdown-viewer.html?v=20260610-plugin-topic-root-level-v697",
  "/app-task-artifact-helpers.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-story-helpers.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-reading-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-coins-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-program-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-task-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-reflection-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-api-client.js?v=20260610-plugin-topic-root-level-v697",
  "/app.js?v=20260610-plugin-topic-root-level-v697",
  "/app-shell-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-task-groups-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-navigation-view-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-chat-composer-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-composer-source-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-composer-context-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-run-progress-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-navigation-search-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-task-preview-helpers-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-task-preview-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-sidebar-task-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-message-skill-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-message-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-route-snapshot-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-platform-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-platform-status-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-pwa-settings-push-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-pwa-push-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-workspace-admin-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-access-key-manager-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-plugin-admin-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-share-image-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-draft-thread-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-directory-automation-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-shared-directory-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-embedded-plugin-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-wardrobe-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-plugin-topics-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-directory-topics-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-action-inbox-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-automation-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-native-growth-submission-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-ai-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-reward-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-settings-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-teaching-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-learning-growth-controller.js?v=20260610-plugin-topic-root-level-v697",
  "/app-automation-controller-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-automation-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-thread-state-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-group-topic-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-core-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-story-core-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-todo-core-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-render-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-list-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-learning-panel-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-recorder-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-todo-detail-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-composer-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-card-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-kanban-study-actions-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-thread-message-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-thread-list-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-thread-directory-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-thread-card-message-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-long-message-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-rich-text-directory-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-message-usage-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-events-composer-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-event-stream-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-upload-sidebar-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-composer-send-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-wire-start-ui.js?v=20260610-plugin-topic-root-level-v697",
  "/app-start.js?v=20260610-plugin-topic-root-level-v697",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260610-plugin-topic-root-level-v697",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
