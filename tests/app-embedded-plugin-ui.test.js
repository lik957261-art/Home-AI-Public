...
assert.match(stylesCss, /\.codex-mode \.conversation,[\s\S]*?\.email-mode \.conversation\s*\{[\s\S]*padding: 0;/);
...
assert.match(stylesCss, /\.bottom-nav\.plugins-visible/);
assert.match(stylesCss, /\.bottom-nav\.codex-visible\.plugins-visible/);
assert.match(stylesCss, /\.bottom-plugin-menu \{/);
assert.match(stylesCss, /\.bottom-plugin-menu-item \{/);
