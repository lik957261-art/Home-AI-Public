...
CRON_MODEL_PROXY_URL="${HERMES_MOBILE_CRON_MODEL_PROXY_URL:-${HERMES_WEB_CRON_MODEL_PROXY_URL:-${HTTPS_PROXY:-${HTTP_PROXY:-${ALL_PROXY:-http://127.0.0.1:7890}}}}}"
...
(
  ...
  export HERMES_MOBILE_CRON_MODEL_PROXY_URL="$CRON_MODEL_PROXY_URL"
  export HTTPS_PROXY="${HTTPS_PROXY:-$CRON_MODEL_PROXY_URL}"
  export HTTP_PROXY="${HTTP_PROXY:-$CRON_MODEL_PROXY_URL}"
  export ALL_PROXY="${ALL_PROXY:-$CRON_MODEL_PROXY_URL}"
