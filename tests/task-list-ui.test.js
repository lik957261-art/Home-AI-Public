...
const CLIENT_VERSION = "20260530-plugin-refresh-v358";
const appJs = [
...
assert.match(directoryViewerHtml, /\/styles\.css\?v=20260530-plugin-refresh-v358/);
assert.match(directoryViewerHtml, /\/markdown-renderer-client\.js\?v=20260530-plugin-refresh-v358/);
assert.match(directoryViewerHtml, /\/app-task-preview-ui\.js\?v=20260530-plugin-refresh-v358/);
