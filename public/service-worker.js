...
const HERMES_SW_VERSION = "20260626-in-app-dialog-contract-v954";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260626-in-app-dialog-contract-v954",
  "/markdown-viewer.html?v=20260626-in-app-dialog-contract-v954",
  "/app-task-artifact-helpers.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-story-helpers.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-reading-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-coins-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-program-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-task-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-reflection-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-api-client.js?v=20260626-in-app-dialog-contract-v954",
  "/app.js?v=20260626-in-app-dialog-contract-v954",
  "/app-dialog-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-shell-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-task-groups-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-navigation-view-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-chat-composer-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-composer-source-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-composer-context-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-run-progress-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-navigation-search-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-task-preview-helpers-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-task-preview-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-sidebar-task-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-message-skill-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-message-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-route-snapshot-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-platform-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-platform-status-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-ai-ops-diagnostics-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-pwa-settings-push-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-pwa-push-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-workspace-admin-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-access-key-manager-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-tts-profile-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-plugin-admin-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-share-image-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-draft-thread-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-directory-automation-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-shared-directory-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-embedded-plugin-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-wardrobe-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-plugin-topics-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-directory-topics-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-action-inbox-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-automation-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-native-growth-submission-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-ai-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-reward-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-settings-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-teaching-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-learning-growth-controller.js?v=20260626-in-app-dialog-contract-v954",
  "/app-automation-controller-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-automation-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-thread-state-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-group-topic-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-core-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-story-core-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-todo-core-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-render-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-list-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-learning-panel-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-recorder-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-todo-detail-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-composer-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-card-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-kanban-study-actions-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-thread-message-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-thread-list-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-thread-directory-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-thread-card-message-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-long-message-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-rich-text-directory-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-message-usage-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-events-composer-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-event-stream-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-upload-sidebar-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-composer-send-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-voice-input-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-voice-learning-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-wire-start-ui.js?v=20260626-in-app-dialog-contract-v954",
  "/app-start.js?v=20260626-in-app-dialog-contract-v954",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260626-in-app-dialog-contract-v954",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
