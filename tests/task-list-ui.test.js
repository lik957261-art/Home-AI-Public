...
const CLIENT_VERSION = "20260619-nav-freeze-inline-images-v862";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260619-nav-freeze-inline-images-v862" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260619-nav-freeze-inline-images-v862"><\/noscript>/);
...
assert.match(appJs, /renderCurrentThread\(\{ stickToBottom: false, restoreScrollTop \}\)/);
...
assert.match(gatewayRunInstructionServiceJs, /20260619-music-cover-url-import-v1/);
...
assert.match(appJs, /function applyPrimaryNavigationViewShell\(\) \{[\s\S]*?applyViewMode\(\);[\s\S]*?scheduleGlobalPluginDockRefresh\("primary_navigation"\);[\s\S]*?updateNavigationControls\(\);/);
assert.match(appJs, /function schedulePrimaryNavigationViewLoad\(options = \{\}\) \{[\s\S]*?applyPrimaryNavigationViewShell\(\);[\s\S]*?scheduleSelectedViewLoad\(Object\.assign\(\{ afterPaint: true \}, options\)\);/);
assert.match(appJs, /function openPinnedPluginBottomTab\(viewMode, rememberReturnRoute = null\) \{[\s\S]*?state\.viewMode = viewMode;[\s\S]*?applyViewMode\(\);[\s\S]*?updateNavigationControls\(\);[\s\S]*?scheduleSelectedViewLoad\(\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(indexHtml, /app-voice-input-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(serviceWorkerJs, /\/app-voice-input-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(indexHtml, /app-voice-learning-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
assert.match(serviceWorkerJs, /\/app-voice-learning-ui\.js\?v=20260619-nav-freeze-inline-images-v862/);
...
assert.match(appJs, /const rawDirectoryTopicCollections = indexedDirectoryTopicCollections \|\| \(/);
