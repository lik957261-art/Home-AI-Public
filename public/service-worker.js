...
const HERMES_SW_VERSION = "20260608-plugin-context-restore-v633";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260608-plugin-context-restore-v633",
  "/markdown-viewer.html?v=20260608-plugin-context-restore-v633",
  "/app-task-artifact-helpers.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-story-helpers.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-reading-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-coins-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-program-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-task-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-reflection-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-api-client.js?v=20260608-plugin-context-restore-v633",
  "/app.js?v=20260608-plugin-context-restore-v633",
  "/app-shell-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-task-groups-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-navigation-view-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-chat-composer-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-composer-source-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-composer-context-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-run-progress-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-navigation-search-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-task-preview-helpers-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-task-preview-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-sidebar-task-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-message-skill-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-message-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-route-snapshot-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-platform-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-platform-status-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-pwa-settings-push-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-pwa-push-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-workspace-admin-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-access-key-manager-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-plugin-admin-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-share-image-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-draft-thread-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-directory-automation-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-shared-directory-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-embedded-plugin-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-wardrobe-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-plugin-topics-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-directory-topics-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-action-inbox-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-automation-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-native-growth-submission-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-ai-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-reward-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-settings-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-teaching-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-learning-growth-controller.js?v=20260608-plugin-context-restore-v633",
  "/app-automation-controller-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-automation-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-thread-state-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-group-topic-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-core-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-story-core-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-todo-core-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-render-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-list-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-learning-panel-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-recorder-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-todo-detail-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-composer-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-card-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-kanban-study-actions-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-thread-message-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-thread-list-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-thread-directory-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-thread-card-message-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-long-message-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-rich-text-directory-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-message-usage-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-events-composer-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-event-stream-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-upload-sidebar-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-composer-send-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-wire-start-ui.js?v=20260608-plugin-context-restore-v633",
  "/app-start.js?v=20260608-plugin-context-restore-v633",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260608-plugin-context-restore-v633",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
