...
const HERMES_SW_VERSION = "20260518-reading-sequence";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260518-reading-sequence",
  "/app-task-artifact-helpers.js?v=20260518-reading-sequence",
  "/app-kanban-story-helpers.js?v=20260518-reading-sequence",
  "/app-learning-reading-ui.js?v=20260518-reading-sequence",
  "/app-learning-coins-ui.js?v=20260518-reading-sequence",
  "/app-learning-program-ui.js?v=20260518-reading-sequence",
  "/app-learning-growth-ui.js?v=20260518-reading-sequence",
  "/app-learning-growth-task-ui.js?v=20260518-reading-sequence",
  "/app-api-client.js?v=20260518-reading-sequence",
  "/app.js?v=20260518-reading-sequence",
  "/app-shell-ui.js?v=20260518-reading-sequence",
  "/app-task-groups-ui.js?v=20260518-reading-sequence",
  "/app-chat-composer-ui.js?v=20260518-reading-sequence",
  "/app-composer-context-ui.js?v=20260518-reading-sequence",
  "/app-run-progress-ui.js?v=20260518-reading-sequence",
  "/app-navigation-search-ui.js?v=20260518-reading-sequence",
  "/app-sidebar-task-ui.js?v=20260518-reading-sequence",
  "/app-message-actions-ui.js?v=20260518-reading-sequence",
  "/app-platform-ui.js?v=20260518-reading-sequence",
  "/app-pwa-settings-push-ui.js?v=20260518-reading-sequence",
  "/app-workspace-admin-ui.js?v=20260518-reading-sequence",
  "/app-access-key-manager-ui.js?v=20260518-reading-sequence",
  "/app-share-image-ui.js?v=20260518-reading-sequence",
  "/app-draft-thread-ui.js?v=20260518-reading-sequence",
  "/app-directory-automation-ui.js?v=20260518-reading-sequence",
  "/app-shared-directory-ui.js?v=20260518-reading-sequence",
  "/app-automation-ui.js?v=20260518-reading-sequence",
  "/app-learning-growth-controller.js?v=20260518-reading-sequence",
  "/app-automation-controller-ui.js?v=20260518-reading-sequence",
  "/app-thread-state-ui.js?v=20260518-reading-sequence",
  "/app-group-topic-ui.js?v=20260518-reading-sequence",
  "/app-kanban-core-ui.js?v=20260518-reading-sequence",
  "/app-kanban-story-core-ui.js?v=20260518-reading-sequence",
  "/app-kanban-todo-core-ui.js?v=20260518-reading-sequence",
  "/app-kanban-render-ui.js?v=20260518-reading-sequence",
  "/app-kanban-list-ui.js?v=20260518-reading-sequence",
  "/app-kanban-learning-panel-ui.js?v=20260518-reading-sequence",
  "/app-kanban-recorder-ui.js?v=20260518-reading-sequence",
  "/app-todo-detail-ui.js?v=20260518-reading-sequence",
  "/app-kanban-actions-ui.js?v=20260518-reading-sequence",
  "/app-kanban-composer-actions-ui.js?v=20260518-reading-sequence",
  "/app-kanban-card-actions-ui.js?v=20260518-reading-sequence",
  "/app-kanban-study-actions-ui.js?v=20260518-reading-sequence",
  "/app-thread-message-ui.js?v=20260518-reading-sequence",
  "/app-thread-list-ui.js?v=20260518-reading-sequence",
  "/app-thread-directory-ui.js?v=20260518-reading-sequence",
  "/app-thread-card-message-ui.js?v=20260518-reading-sequence",
  "/app-rich-text-directory-ui.js?v=20260518-reading-sequence",
  "/app-message-usage-ui.js?v=20260518-reading-sequence",
  "/app-events-composer-ui.js?v=20260518-reading-sequence",
  "/app-event-stream-ui.js?v=20260518-reading-sequence",
  "/app-upload-sidebar-ui.js?v=20260518-reading-sequence",
  "/app-composer-send-ui.js?v=20260518-reading-sequence",
  "/app-wire-start-ui.js?v=20260518-reading-sequence",
  "/app-start.js?v=20260518-reading-sequence",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260518-reading-sequence",
  "/file-viewer.html",
