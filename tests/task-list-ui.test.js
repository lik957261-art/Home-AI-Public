...
const CLIENT_VERSION = "20260608-workspace-onboarding-ui-v636";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260608-workspace-onboarding-ui-v636" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260608-workspace-onboarding-ui-v636"><\/noscript>/);
...
assert.match(appJs, /window\.visualViewport\?\.height[\s\S]*?window\.innerHeight[\s\S]*?document\.documentElement\?\.clientHeight/);
assert.match(appJs, /const viewportOverflow = Math\.max\(0, appHeight - viewportHeight\)/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260608-workspace-onboarding-ui-v636/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260608-workspace-onboarding-ui-v636/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260608-workspace-onboarding-ui-v636/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260608-workspace-onboarding-ui-v636/);
