...
assert.match(script, /appUrl: process\.env\.HOMEAI_VISUAL_DEBUG_APP_URL \|\| "http:\/\/127\.0\.0\.1:8797\/\?source=pwa"/);
...
assert.match(script, /"appium:includeSafariInWebviews": true/);
assert.match(script, /"appium:webviewConnectTimeout": Math\.max\(12000, Number\(args\.appiumTimeoutMs \|\| 15000\)\)/);
...
assert.match(script, /coordinateCalibration: null/);
assert.match(script, /function nativeCoordinateCalibration\(options = \{\}\)/);
assert.match(script, /__homeAiNativeCoordinateProbe/);
assert.match(script, /calibrateWebToRealCoordinatesTranslation/);
assert.match(script, /function coordinateSpaceRequiresCalibration\(value\)/);
assert.match(script, /function nativeCoordinatePoint\(point = \{\}, rect = \{\}, calibration = null\)/);
assert.match(script, /coordinateSpace: body\.coordinateSpace/);
assert.match(script, /function nativeTouchSequenceNormalized\(sequence = \{\}\)/);
assert.match(script, /function nativeLongPressNormalized\(x, y, options = \{\}\)/);
assert.match(script, /function nativeSwipeNormalized\(body = \{\}\)/);
...
assert.match(mobileContract, /20260610-visual-toolchain-shared-lane/);
...
assert.match(platformContract, /visual_toolchain_contract/);
assert.match(platformContract, /20260610-visual-toolchain-shared-lane/);
