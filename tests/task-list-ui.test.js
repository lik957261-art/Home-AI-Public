...
assert.match(mobileRuntimeGatewayFacadeServiceJs, /gatewayPoolStatusHealthy: defaultGatewayPoolStatusHealthy/);
assert.match(mobileRuntimeGatewayFacadeServiceJs, /status\.fallbackError = status\.error \|\| ""/);
