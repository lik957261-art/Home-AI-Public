...
const HERMES_SW_VERSION = "20260518-growth-display-v14";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260518-growth-display-v14",
  "/app-task-artifact-helpers.js?v=20260518-growth-display-v14",
  "/app-kanban-story-helpers.js?v=20260518-growth-display-v14",
  "/app-learning-reading-ui.js?v=20260518-growth-display-v14",
  "/app-learning-coins-ui.js?v=20260518-growth-display-v14",
  "/app-learning-program-ui.js?v=20260518-growth-display-v14",
  "/app-learning-growth-ui.js?v=20260518-growth-display-v14",
  "/app-learning-growth-task-ui.js?v=20260518-growth-display-v14",
  "/app-api-client.js?v=20260518-growth-display-v14",
  "/app.js?v=20260518-growth-display-v14",
  "/app-shell-ui.js?v=20260518-growth-display-v14",
  "/app-task-groups-ui.js?v=20260518-growth-display-v14",
  "/app-chat-composer-ui.js?v=20260518-growth-display-v14",
  "/app-composer-context-ui.js?v=20260518-growth-display-v14",
  "/app-run-progress-ui.js?v=20260518-growth-display-v14",
  "/app-navigation-search-ui.js?v=20260518-growth-display-v14",
  "/app-sidebar-task-ui.js?v=20260518-growth-display-v14",
  "/app-message-actions-ui.js?v=20260518-growth-display-v14",
  "/app-platform-ui.js?v=20260518-growth-display-v14",
  "/app-pwa-settings-push-ui.js?v=20260518-growth-display-v14",
  "/app-workspace-admin-ui.js?v=20260518-growth-display-v14",
  "/app-access-key-manager-ui.js?v=20260518-growth-display-v14",
  "/app-share-image-ui.js?v=20260518-growth-display-v14",
  "/app-draft-thread-ui.js?v=20260518-growth-display-v14",
  "/app-directory-automation-ui.js?v=20260518-growth-display-v14",
  "/app-shared-directory-ui.js?v=20260518-growth-display-v14",
  "/app-automation-ui.js?v=20260518-growth-display-v14",
  "/app-learning-growth-controller.js?v=20260518-growth-display-v14",
  "/app-automation-controller-ui.js?v=20260518-growth-display-v14",
  "/app-thread-state-ui.js?v=20260518-growth-display-v14",
  "/app-group-topic-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-core-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-story-core-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-todo-core-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-render-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-list-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-learning-panel-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-recorder-ui.js?v=20260518-growth-display-v14",
  "/app-todo-detail-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-actions-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-composer-actions-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-card-actions-ui.js?v=20260518-growth-display-v14",
  "/app-kanban-study-actions-ui.js?v=20260518-growth-display-v14",
  "/app-thread-message-ui.js?v=20260518-growth-display-v14",
  "/app-thread-list-ui.js?v=20260518-growth-display-v14",
  "/app-thread-directory-ui.js?v=20260518-growth-display-v14",
  "/app-thread-card-message-ui.js?v=20260518-growth-display-v14",
  "/app-rich-text-directory-ui.js?v=20260518-growth-display-v14",
  "/app-message-usage-ui.js?v=20260518-growth-display-v14",
  "/app-events-composer-ui.js?v=20260518-growth-display-v14",
  "/app-event-stream-ui.js?v=20260518-growth-display-v14",
  "/app-upload-sidebar-ui.js?v=20260518-growth-display-v14",
  "/app-composer-send-ui.js?v=20260518-growth-display-v14",
  "/app-wire-start-ui.js?v=20260518-growth-display-v14",
  "/app-start.js?v=20260518-growth-display-v14",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260518-growth-display-v14",
  "/file-viewer.html",
