...
ROOT="${HOMEAI_PRODUCTION_ROOT:-$(cd "${APP_DIR}/.." && pwd)}"
...
OPERATOR_HOME="${HOMEAI_DISASTER_BACKUP_OPERATOR_HOME:-${HOME:-/Users/Shared}}"
STAGING="${HOMEAI_DISASTER_BACKUP_STAGING:-${OPERATOR_HOME%/}/HomeAI-Disaster-Staging/mac-production}"
DEFAULT_NFS_DESTINATION="${HOMEAI_NAS_BACKUP_MOUNT:-/Users/Shared/HomeAI-NAS-Backup}"
