...
const CLIENT_VERSION = "20260604-note-receipt-save-v554";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260604-note-receipt-save-v554" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260604-note-receipt-save-v554"><\/noscript>/);
...
assert.match(stylesCss, /\.bottom-nav \{[\s\S]*?z-index: 40;[\s\S]*?--bottom-nav-column-min: 48px;[\s\S]*?grid-template-columns: repeat\(5, minmax\(var\(--bottom-nav-column-min\), 1fr\)\);[\s\S]*?padding: 4px env\(safe-area-inset-right\) calc\(3px \+ env\(safe-area-inset-bottom\)\) env\(safe-area-inset-left\);[\s\S]*?overflow-x: hidden;/);
...
assert.match(stylesCss, /\.plugin-context-nav-mode \.bottom-nav \{[\s\S]*?padding: 5px max\(22px, env\(safe-area-inset-right\)\) calc\(5px \+ env\(safe-area-inset-bottom\)\) max\(22px, env\(safe-area-inset-left\)\);/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260604-note-receipt-save-v554/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260604-note-receipt-save-v554/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260604-note-receipt-save-v554/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260604-note-receipt-save-v554/);
