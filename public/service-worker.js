...
const HERMES_SW_VERSION = "20260519-source-icons-v2";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260519-source-icons-v2",
  "/app-task-artifact-helpers.js?v=20260519-source-icons-v2",
  "/app-kanban-story-helpers.js?v=20260519-source-icons-v2",
  "/app-learning-reading-ui.js?v=20260519-source-icons-v2",
  "/app-learning-coins-ui.js?v=20260519-source-icons-v2",
  "/app-learning-program-ui.js?v=20260519-source-icons-v2",
  "/app-learning-growth-ui.js?v=20260519-source-icons-v2",
  "/app-learning-growth-task-ui.js?v=20260519-source-icons-v2",
  "/app-api-client.js?v=20260519-source-icons-v2",
  "/app.js?v=20260519-source-icons-v2",
  "/app-shell-ui.js?v=20260519-source-icons-v2",
  "/app-task-groups-ui.js?v=20260519-source-icons-v2",
  "/app-chat-composer-ui.js?v=20260519-source-icons-v2",
  "/app-composer-source-ui.js?v=20260519-source-icons-v2",
  "/app-composer-context-ui.js?v=20260519-source-icons-v2",
  "/app-run-progress-ui.js?v=20260519-source-icons-v2",
  "/app-navigation-search-ui.js?v=20260519-source-icons-v2",
  "/app-sidebar-task-ui.js?v=20260519-source-icons-v2",
  "/app-message-actions-ui.js?v=20260519-source-icons-v2",
  "/app-platform-ui.js?v=20260519-source-icons-v2",
  "/app-pwa-settings-push-ui.js?v=20260519-source-icons-v2",
  "/app-workspace-admin-ui.js?v=20260519-source-icons-v2",
  "/app-access-key-manager-ui.js?v=20260519-source-icons-v2",
  "/app-share-image-ui.js?v=20260519-source-icons-v2",
  "/app-draft-thread-ui.js?v=20260519-source-icons-v2",
  "/app-directory-automation-ui.js?v=20260519-source-icons-v2",
  "/app-shared-directory-ui.js?v=20260519-source-icons-v2",
  "/app-automation-ui.js?v=20260519-source-icons-v2",
  "/app-learning-growth-controller.js?v=20260519-source-icons-v2",
  "/app-automation-controller-ui.js?v=20260519-source-icons-v2",
  "/app-thread-state-ui.js?v=20260519-source-icons-v2",
  "/app-group-topic-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-core-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-story-core-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-todo-core-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-render-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-list-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-learning-panel-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-recorder-ui.js?v=20260519-source-icons-v2",
  "/app-todo-detail-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-actions-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-composer-actions-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-card-actions-ui.js?v=20260519-source-icons-v2",
  "/app-kanban-study-actions-ui.js?v=20260519-source-icons-v2",
  "/app-thread-message-ui.js?v=20260519-source-icons-v2",
  "/app-thread-list-ui.js?v=20260519-source-icons-v2",
  "/app-thread-directory-ui.js?v=20260519-source-icons-v2",
  "/app-thread-card-message-ui.js?v=20260519-source-icons-v2",
  "/app-rich-text-directory-ui.js?v=20260519-source-icons-v2",
  "/app-message-usage-ui.js?v=20260519-source-icons-v2",
  "/app-events-composer-ui.js?v=20260519-source-icons-v2",
  "/app-event-stream-ui.js?v=20260519-source-icons-v2",
  "/app-upload-sidebar-ui.js?v=20260519-source-icons-v2",
  "/app-composer-send-ui.js?v=20260519-source-icons-v2",
  "/app-wire-start-ui.js?v=20260519-source-icons-v2",
  "/app-start.js?v=20260519-source-icons-v2",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260519-source-icons-v2",
  "/file-viewer.html",
