...
assert.match(gatewayToolSchemaSmoke, /toolNamesFromSession/);
...
assert.match(videoPluginManifest, /provides_tools:\s*\r?\n\s+- video_gen/);
assert.match(videoPlugin, /VIDEO_GENERATE_SCHEMA/);
assert.match(videoPlugin, /"name": "video_generate"/);
assert.match(videoPlugin, /toolset="video_gen"/);
assert.match(videoPlugin, /override=True/);
