...
const HERMES_SW_VERSION = "20260613-voice-input-asr-v723";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260613-voice-input-asr-v723",
  "/markdown-viewer.html?v=20260613-voice-input-asr-v723",
  "/app-task-artifact-helpers.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-story-helpers.js?v=20260613-voice-input-asr-v723",
  "/app-learning-reading-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-coins-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-program-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-task-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-reflection-ui.js?v=20260613-voice-input-asr-v723",
  "/app-api-client.js?v=20260613-voice-input-asr-v723",
  "/app.js?v=20260613-voice-input-asr-v723",
  "/app-shell-ui.js?v=20260613-voice-input-asr-v723",
  "/app-task-groups-ui.js?v=20260613-voice-input-asr-v723",
  "/app-navigation-view-ui.js?v=20260613-voice-input-asr-v723",
  "/app-chat-composer-ui.js?v=20260613-voice-input-asr-v723",
  "/app-composer-source-ui.js?v=20260613-voice-input-asr-v723",
  "/app-composer-context-ui.js?v=20260613-voice-input-asr-v723",
  "/app-run-progress-ui.js?v=20260613-voice-input-asr-v723",
  "/app-navigation-search-ui.js?v=20260613-voice-input-asr-v723",
  "/app-task-preview-helpers-ui.js?v=20260613-voice-input-asr-v723",
  "/app-task-preview-ui.js?v=20260613-voice-input-asr-v723",
  "/app-sidebar-task-ui.js?v=20260613-voice-input-asr-v723",
  "/app-message-skill-ui.js?v=20260613-voice-input-asr-v723",
  "/app-message-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-route-snapshot-ui.js?v=20260613-voice-input-asr-v723",
  "/app-platform-ui.js?v=20260613-voice-input-asr-v723",
  "/app-platform-status-ui.js?v=20260613-voice-input-asr-v723",
  "/app-pwa-settings-push-ui.js?v=20260613-voice-input-asr-v723",
  "/app-pwa-push-ui.js?v=20260613-voice-input-asr-v723",
  "/app-workspace-admin-ui.js?v=20260613-voice-input-asr-v723",
  "/app-access-key-manager-ui.js?v=20260613-voice-input-asr-v723",
  "/app-plugin-admin-ui.js?v=20260613-voice-input-asr-v723",
  "/app-share-image-ui.js?v=20260613-voice-input-asr-v723",
  "/app-draft-thread-ui.js?v=20260613-voice-input-asr-v723",
  "/app-directory-automation-ui.js?v=20260613-voice-input-asr-v723",
  "/app-shared-directory-ui.js?v=20260613-voice-input-asr-v723",
  "/app-embedded-plugin-ui.js?v=20260613-voice-input-asr-v723",
  "/app-wardrobe-ui.js?v=20260613-voice-input-asr-v723",
  "/app-plugin-topics-ui.js?v=20260613-voice-input-asr-v723",
  "/app-directory-topics-ui.js?v=20260613-voice-input-asr-v723",
  "/app-action-inbox-ui.js?v=20260613-voice-input-asr-v723",
  "/app-automation-ui.js?v=20260613-voice-input-asr-v723",
  "/app-learning-native-growth-submission-controller.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-ai-controller.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-reward-controller.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-settings-controller.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-teaching-controller.js?v=20260613-voice-input-asr-v723",
  "/app-learning-growth-controller.js?v=20260613-voice-input-asr-v723",
  "/app-automation-controller-ui.js?v=20260613-voice-input-asr-v723",
  "/app-automation-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-thread-state-ui.js?v=20260613-voice-input-asr-v723",
  "/app-group-topic-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-core-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-story-core-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-todo-core-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-render-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-list-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-learning-panel-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-recorder-ui.js?v=20260613-voice-input-asr-v723",
  "/app-todo-detail-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-composer-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-card-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-kanban-study-actions-ui.js?v=20260613-voice-input-asr-v723",
  "/app-thread-message-ui.js?v=20260613-voice-input-asr-v723",
  "/app-thread-list-ui.js?v=20260613-voice-input-asr-v723",
  "/app-thread-directory-ui.js?v=20260613-voice-input-asr-v723",
  "/app-thread-card-message-ui.js?v=20260613-voice-input-asr-v723",
  "/app-long-message-ui.js?v=20260613-voice-input-asr-v723",
  "/app-rich-text-directory-ui.js?v=20260613-voice-input-asr-v723",
  "/app-message-usage-ui.js?v=20260613-voice-input-asr-v723",
  "/app-events-composer-ui.js?v=20260613-voice-input-asr-v723",
  "/app-event-stream-ui.js?v=20260613-voice-input-asr-v723",
  "/app-upload-sidebar-ui.js?v=20260613-voice-input-asr-v723",
  "/app-composer-send-ui.js?v=20260613-voice-input-asr-v723",
  "/app-voice-input-ui.js?v=20260613-voice-input-asr-v723",
  "/app-wire-start-ui.js?v=20260613-voice-input-asr-v723",
  "/app-start.js?v=20260613-voice-input-asr-v723",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260613-voice-input-asr-v723",
  "/file-viewer.html",
  "/pdf-viewer.html",
  "/manifest.json",
