...
const HERMES_SW_VERSION = "20260517-app-kanban-actions-split";
...
const HERMES_APP_SHELL_URLS = [
  ...
  "/hermes-mobile/",
  "/index.html",
  "/styles.css?v=20260517-app-kanban-actions-split",
  "/app-task-artifact-helpers.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-story-helpers.js?v=20260517-app-kanban-actions-split",
  "/app-learning-reading-ui.js?v=20260517-app-kanban-actions-split",
  "/app-learning-coins-ui.js?v=20260517-app-kanban-actions-split",
  "/app-learning-program-ui.js?v=20260517-app-kanban-actions-split",
  "/app-learning-growth-ui.js?v=20260517-app-kanban-actions-split",
  "/app-api-client.js?v=20260517-app-kanban-actions-split",
  "/app.js?v=20260517-app-kanban-actions-split",
  "/app-shell-ui.js?v=20260517-app-kanban-actions-split",
  "/app-task-groups-ui.js?v=20260517-app-kanban-actions-split",
  "/app-chat-composer-ui.js?v=20260517-app-kanban-actions-split",
  "/app-navigation-search-ui.js?v=20260517-app-kanban-actions-split",
  "/app-sidebar-task-ui.js?v=20260517-app-kanban-actions-split",
  "/app-message-actions-ui.js?v=20260517-app-kanban-actions-split",
  "/app-platform-ui.js?v=20260517-app-kanban-actions-split",
  "/app-pwa-settings-push-ui.js?v=20260517-app-kanban-actions-split",
  "/app-workspace-admin-ui.js?v=20260517-app-kanban-actions-split",
  "/app-access-key-manager-ui.js?v=20260517-app-kanban-actions-split",
  "/app-share-image-ui.js?v=20260517-app-kanban-actions-split",
  "/app-draft-thread-ui.js?v=20260517-app-kanban-actions-split",
  "/app-directory-automation-ui.js?v=20260517-app-kanban-actions-split",
  "/app-shared-directory-ui.js?v=20260517-app-kanban-actions-split",
  "/app-automation-ui.js?v=20260517-app-kanban-actions-split",
  "/app-learning-growth-controller.js?v=20260517-app-kanban-actions-split",
  "/app-automation-controller-ui.js?v=20260517-app-kanban-actions-split",
  "/app-thread-state-ui.js?v=20260517-app-kanban-actions-split",
  "/app-group-topic-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-core-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-story-core-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-todo-core-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-render-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-list-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-learning-panel-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-recorder-ui.js?v=20260517-app-kanban-actions-split",
  "/app-todo-detail-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-actions-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-composer-actions-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-card-actions-ui.js?v=20260517-app-kanban-actions-split",
  "/app-kanban-study-actions-ui.js?v=20260517-app-kanban-actions-split",
  "/app-thread-message-ui.js?v=20260517-app-kanban-actions-split",
  "/app-thread-list-ui.js?v=20260517-app-kanban-actions-split",
  "/app-thread-directory-ui.js?v=20260517-app-kanban-actions-split",
  "/app-thread-card-message-ui.js?v=20260517-app-kanban-actions-split",
  "/app-rich-text-directory-ui.js?v=20260517-app-kanban-actions-split",
  "/app-message-usage-ui.js?v=20260517-app-kanban-actions-split",
  "/app-events-composer-ui.js?v=20260517-app-kanban-actions-split",
  "/app-event-stream-ui.js?v=20260517-app-kanban-actions-split",
  "/app-upload-sidebar-ui.js?v=20260517-app-kanban-actions-split",
  "/app-composer-send-ui.js?v=20260517-app-kanban-actions-split",
  "/app-wire-start-ui.js?v=20260517-app-kanban-actions-split",
  "/app-start.js?v=20260517-app-kanban-actions-split",
  "/fixed-viewport.js?v=20260505-1135",
  "/markdown-renderer-client.js?v=20260517-app-kanban-actions-split",
  "/file-viewer.html",
