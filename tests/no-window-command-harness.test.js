...
const LEGACY_COMPLEX_INLINE_BASELINE = new Set([
  ...
  "scripts\\start-gateway-pool.ps1:450: complex inline command must be moved to a script file",
  "scripts\\start-gateway-pool.ps1:711: complex inline command must be moved to a script file",
