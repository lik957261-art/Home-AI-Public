...
const CLIENT_VERSION = "20260610-growth-host-entry-v682";
const appJs = [
...
assert.match(indexHtml, /<link rel="preload" href="\/styles\.css\?v=20260610-growth-host-entry-v682" as="style" onload="this\.onload=null;this\.rel='stylesheet'">/);
assert.match(indexHtml, /<noscript><link rel="stylesheet" href="\/styles\.css\?v=20260610-growth-host-entry-v682"><\/noscript>/);
...
assert.match(indexHtml, /app-plugin-topics-ui\.js\?v=20260610-growth-host-entry-v682/);
assert.match(serviceWorkerJs, /\/app-plugin-topics-ui\.js\?v=20260610-growth-host-entry-v682/);
assert.match(indexHtml, /app-directory-topics-ui\.js\?v=20260610-growth-host-entry-v682/);
assert.match(serviceWorkerJs, /\/app-directory-topics-ui\.js\?v=20260610-growth-host-entry-v682/);
...
assert.match(appJs, /function renderPluginTopicActions\(def\)/);
assert.match(appJs, /if \(def\?\.builtinKind === "directory"\) return "";/);
...
assert.match(appJs, /availablePluginTopicDefs\(\)\.filter\(\(def\) => def\.builtinKind === "directory"\)/);
...
assert.match(appJs, /const specialClass = def\.builtinKind === "directory" \? " directory-special-plugin" : ""/);
assert.match(appJs, /data-plugin-topic-open-app/);
assert.match(appJs, /data-plugin-topic-open-topic/);
assert.match(appJs, /data-plugin-topic-open-delivery/);
...
assert.match(appJs, /const directoryTopicCollections = directoryTopicCollectionsReady && typeof directoryTopicCollectionsForGroups === "function"/);
...
assert.match(appJs, /return directoryTopicCollectionsReady \? !directoryTopicGroupIds\.has\(group\.id\) : !hasDirectoryTopicRoute/);
